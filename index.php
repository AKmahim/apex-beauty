...
<section class="hero">
  ...
  <div class="hero-inner">
    <div>
      ...
      <div class="hero-ctas">
        <a href="#" class="cta-btn" onclick="openConsult(event)" data-ckey="hero.ctaPrimary"<?= apex_cms_attrs_or($cmsHome['hero']['ctaPrimary'] ?? null, ['de' => "Kostenlose Beratung sichern", 'en' => "Get your free consultation"]) ?>><?= apex_cms_value_or($cmsHome['hero']['ctaPrimary'] ?? null, ['de' => "Kostenlose Beratung sichern", 'en' => "Get your free consultation"], $currentLang) ?></a>
...
<div class="consult-overlay" id="consultOverlay">
  <div class="consult-modal" role="dialog" aria-modal="true" aria-labelledby="consultTitle">
    ...
    <div class="consult-pane" id="cpane2">
      ...
      <div class="consult-nav">
        <button type="button" class="cback" onclick="gotoStep(1)" data-ckey="faq.t49"<?= apex_cms_attrs_or($cmsHome['faq']['t49'] ?? null, ['de' => "Zurück", 'en' => "Back", 'fr' => "Retour", 'nl' => "Terug", 'it' => "Indietro", 'tr' => "Geri"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t49'] ?? null, ['de' => "Zurück", 'en' => "Back", 'fr' => "Retour", 'nl' => "Terug", 'it' => "Indietro", 'tr' => "Geri"], $currentLang) ?></button>
    ...
    <div class="consult-pane" id="cpane3">
      ...
      <div class="consult-nav">
        <button type="button" class="cback" onclick="gotoStep(2)" data-ckey="faq.t64"<?= apex_cms_attrs_or($cmsHome['faq']['t64'] ?? null, ['de' => "Zurück", 'en' => "Back", 'fr' => "Retour", 'nl' => "Terug", 'it' => "Indietro", 'tr' => "Geri"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t64'] ?? null, ['de' => "Zurück", 'en' => "Back", 'fr' => "Retour", 'nl' => "Terug", 'it' => "Indietro", 'tr' => "Geri"], $currentLang) ?></button>
