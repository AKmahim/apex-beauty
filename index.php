...
// Same content the admin panel edits, rendered into the HTML rather than
// swapped in by JavaScript afterwards, so an edit is visible to crawlers.
$cmsHome = $homeContent;
...
<?php if ($faqSchema): ?>
<script type="application/ld+json" nonce="<?= htmlspecialchars(apex_csp_nonce(), ENT_QUOTES) ?>"><?= json_encode($faqSchema, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE) ?></script>
<?php endif; ?>
...
<link href="/assets/fonts/urbanist.css" rel="stylesheet">
<script type="importmap" nonce="<?= htmlspecialchars(apex_csp_nonce(), ENT_QUOTES) ?>">
{
  "imports": {
    "three": "/assets/vendor/three-0.167.0.module.js"
  }
}
</script>
      ...
      <div class="announce-track" id="announceTrack">
        <div class="announce-items">
          <div class="announce-item">
            ...
            <b data-ckey="intro.t1"<?= apex_cms_attrs_or($cmsHome['intro']['t1'] ?? null, ['de' => "Beratung – Vor Ort, Österreich", 'en' => "Consultation - In person, Austria", 'fr' => "Consultation - En personne, Autriche", 'nl' => "Consult - Persoonlijk, Oostenrijk", 'it' => "Consulenza - Di persona, Austria", 'tr' => "Danışma - Yüz Yüze, Avusturya"]) ?>><?= apex_cms_value_or($cmsHome['intro']['t1'] ?? null, ['de' => "Beratung – Vor Ort, Österreich", 'en' => "Consultation - In person, Austria", 'fr' => "Consultation - En personne, Autriche", 'nl' => "Consult - Persoonlijk, Oostenrijk", 'it' => "Consulenza - Di persona, Austria", 'tr' => "Danışma - Yüz Yüze, Avusturya"], $currentLang) ?></b>
          </div>
          ...
          <div class="announce-item">
            ...
            <b data-ckey="intro.t2"<?= apex_cms_attrs_or($cmsHome['intro']['t2'] ?? null, ['de' => "Reise in die Türkei – Wir organisieren alles", 'en' => "Trip to Turkey - We handle it all", 'fr' => "Voyage en Turquie - Nous nous occupons de tout", 'nl' => "Reis naar Turkije - Wij regelen alles", 'it' => "Viaggio in Turchia - Ci occupiamo di tutto", 'tr' => "Türkiye Seyahati - Her Şeyi Biz Ayarlıyoruz"]) ?>><?= apex_cms_value_or($cmsHome['intro']['t2'] ?? null, ['de' => "Reise in die Türkei – Wir organisieren alles", 'en' => "Trip to Turkey - We handle it all", 'fr' => "Voyage en Turquie - Nous nous occupons de tout", 'nl' => "Reis naar Turkije - Wij regelen alles", 'it' => "Viaggio in Turchia - Ci occupiamo di tutto", 'tr' => "Türkiye Seyahati - Her Şeyi Biz Ayarlıyoruz"], $currentLang) ?></b>
          </div>
          <div class="announce-divider"></div>
          <div class="announce-item">
            ...
            <b data-ckey="intro.t3"<?= apex_cms_attrs_or($cmsHome['intro']['t3'] ?? null, ['de' => "Behandlung – Hauptklinik Türkei", 'en' => "Treatment - Main Clinic Turkey", 'fr' => "Traitement - Clinique principale en Turquie", 'nl' => "Behandeling - Hoofdkliniek Turkije", 'it' => "Trattamento - Clinica principale in Turchia", 'tr' => "Tedavi - Ana Klinik Türkiye"]) ?>><?= apex_cms_value_or($cmsHome['intro']['t3'] ?? null, ['de' => "Behandlung – Hauptklinik Türkei", 'en' => "Treatment - Main Clinic Turkey", 'fr' => "Traitement - Clinique principale en Turquie", 'nl' => "Behandeling - Hoofdkliniek Turkije", 'it' => "Trattamento - Clinica principale in Turchia", 'tr' => "Tedavi - Ana Klinik Türkiye"], $currentLang) ?></b>
          </div>
          <div class="announce-divider"></div>
          <div class="announce-item">
            ...
            <b data-ckey="intro.t4"<?= apex_cms_attrs_or($cmsHome['intro']['t4'] ?? null, ['de' => "Größtes Nachsorge-Netzwerk – AT·DE·CH", 'en' => "Largest Aftercare Network - AT·DE·CH", 'fr' => "Plus grand réseau de suivi - AT·DE·CH", 'nl' => "Grootste nazorgnetwerk - AT·DE·CH", 'it' => "La più grande rete di assistenza post-operatoria - AT·DE·CH", 'tr' => "En Büyük Bakım Sonrası Ağı - AT·DE·CH"]) ?>><?= apex_cms_value_or($cmsHome['intro']['t4'] ?? null, ['de' => "Größtes Nachsorge-Netzwerk – AT·DE·CH", 'en' => "Largest Aftercare Network - AT·DE·CH", 'fr' => "Plus grand réseau de suivi - AT·DE·CH", 'nl' => "Grootste nazorgnetwerk - AT·DE·CH", 'it' => "La più grande rete di assistenza post-operatoria - AT·DE·CH", 'tr' => "En Büyük Bakım Sonrası Ağı - AT·DE·CH"], $currentLang) ?></b>
          </div>
          <div class="announce-divider"></div>
        </div>
        <div class="announce-items" aria-hidden="true">
          <div class="announce-item">
            ...
            <b data-ckey="intro.t5"<?= apex_cms_attrs_or($cmsHome['intro']['t5'] ?? null, ['de' => "Beratung – Vor Ort, Österreich", 'en' => "Consultation - In person, Austria", 'fr' => "Consultation - En personne, Autriche", 'nl' => "Consult - Persoonlijk, Oostenrijk", 'it' => "Consulenza - Di persona, Austria", 'tr' => "Danışma - Yüz Yüze, Avusturya"]) ?>><?= apex_cms_value_or($cmsHome['intro']['t5'] ?? null, ['de' => "Beratung – Vor Ort, Österreich", 'en' => "Consultation - In person, Austria", 'fr' => "Consultation - En personne, Autriche", 'nl' => "Consult - Persoonlijk, Oostenrijk", 'it' => "Consulenza - Di persona, Austria", 'tr' => "Danışma - Yüz Yüze, Avusturya"], $currentLang) ?></b>
          </div>
          <div class="announce-divider"></div>
          <div class="announce-item">
            ...
            <b data-ckey="intro.t6"<?= apex_cms_attrs_or($cmsHome['intro']['t6'] ?? null, ['de' => "Reise in die Türkei – Wir organisieren alles", 'en' => "Trip to Turkey - We handle it all", 'fr' => "Voyage en Turquie - Nous nous occupons de tout", 'nl' => "Reis naar Turkije - Wij regelen alles", 'it' => "Viaggio in Turchia - Ci occupiamo di tutto", 'tr' => "Türkiye Seyahati - Her Şeyi Biz Ayarlıyoruz"]) ?>><?= apex_cms_value_or($cmsHome['intro']['t6'] ?? null, ['de' => "Reise in die Türkei – Wir organisieren alles", 'en' => "Trip to Turkey - We handle it all", 'fr' => "Voyage en Turquie - Nous nous occupons de tout", 'nl' => "Reis naar Turkije - Wij regelen alles", 'it' => "Viaggio in Turchia - Ci occupiamo di tutto", 'tr' => "Türkiye Seyahati - Her Şeyi Biz Ayarlıyoruz"], $currentLang) ?></b>
          </div>
          <div class="announce-divider"></div>
          <div class="announce-item">
            ...
            <b data-ckey="intro.t7"<?= apex_cms_attrs_or($cmsHome['intro']['t7'] ?? null, ['de' => "Behandlung – Hauptklinik Türkei", 'en' => "Treatment - Main Clinic Turkey", 'fr' => "Traitement - Clinique principale en Turquie", 'nl' => "Behandeling - Hoofdkliniek Turkije", 'it' => "Trattamento - Clinica principale in Turchia", 'tr' => "Tedavi - Ana Klinik Türkiye"]) ?>><?= apex_cms_value_or($cmsHome['intro']['t7'] ?? null, ['de' => "Behandlung – Hauptklinik Türkei", 'en' => "Treatment - Main Clinic Turkey", 'fr' => "Traitement - Clinique principale en Turquie", 'nl' => "Behandeling - Hoofdkliniek Turkije", 'it' => "Trattamento - Clinica principale in Turchia", 'tr' => "Tedavi - Ana Klinik Türkiye"], $currentLang) ?></b>
          </div>
          <div class="announce-divider"></div>
          <div class="announce-item">
            ...
            <b data-ckey="intro.t8"<?= apex_cms_attrs_or($cmsHome['intro']['t8'] ?? null, ['de' => "Größtes Nachsorge-Netzwerk – AT·DE·CH", 'en' => "Largest Aftercare Network - AT·DE·CH", 'fr' => "Plus grand réseau de suivi - AT·DE·CH", 'nl' => "Grootste nazorgnetwerk - AT·DE·CH", 'it' => "La più grande rete di assistenza post-operatoria - AT·DE·CH", 'tr' => "En Büyük Bakım Sonrası Ağı - AT·DE·CH"]) ?>><?= apex_cms_value_or($cmsHome['intro']['t8'] ?? null, ['de' => "Größtes Nachsorge-Netzwerk – AT·DE·CH", 'en' => "Largest Aftercare Network - AT·DE·CH", 'fr' => "Plus grand réseau de suivi - AT·DE·CH", 'nl' => "Grootste nazorgnetwerk - AT·DE·CH", 'it' => "La più grande rete di assistenza post-operatoria - AT·DE·CH", 'tr' => "En Büyük Bakım Sonrası Ağı - AT·DE·CH"], $currentLang) ?></b>
          </div>
          <div class="announce-divider"></div>
        </div>
      </div>
    </div>
    <button type="button" class="announce-close" data-click="close-announce" aria-label="Close">✕</button>
  </div>
</div>
...
<section class="hero">
  ...
  <div class="hero-inner">
    <div>
      <a href="#network" class="eyebrow"><span class="dot"></span><span data-ckey="hero.eyebrow"<?= apex_cms_attrs_or($cmsHome['hero']['eyebrow'] ?? null, ['de' => "Basiert in Österreich · Größtes Nachsorge-Netzwerk", 'en' => "Based in Austria · Largest Aftercare Network"]) ?>><?= apex_cms_value_or($cmsHome['hero']['eyebrow'] ?? null, ['de' => "Basiert in Österreich · Größtes Nachsorge-Netzwerk", 'en' => "Based in Austria · Largest Aftercare Network"], $currentLang) ?></span></a>
      <h1>
        <span data-ckey="hero.headline1"<?= apex_cms_attrs_or($cmsHome['hero']['headline1'] ?? null, ['de' => "Ihre komplette Haartransplantation.", 'en' => "Your complete hair transplant journey."]) ?>><?= apex_cms_value_or($cmsHome['hero']['headline1'] ?? null, ['de' => "Ihre komplette Haartransplantation.", 'en' => "Your complete hair transplant journey."], $currentLang) ?></span><br>
        <span class="hl" data-ckey="hero.headline2"<?= apex_cms_attrs_or($cmsHome['hero']['headline2'] ?? null, ['de' => "Professionell begleitet von der Beratung bis zur Nachsorge.", 'en' => "Professionally managed from consultation to aftercare."]) ?>><?= apex_cms_value_or($cmsHome['hero']['headline2'] ?? null, ['de' => "Professionell begleitet von der Beratung bis zur Nachsorge.", 'en' => "Professionally managed from consultation to aftercare."], $currentLang) ?></span>
      </h1>
      <p class="hero-sub" data-ckey="hero.sub"<?= apex_cms_attrs_or($cmsHome['hero']['sub'] ?? null, ['de' => "Persönliche Beratung in Österreich, Behandlung in unserer führenden Klinik in der Türkei und professionelle Nachsorge in Österreich, Deutschland und der Schweiz. Mit einer ärztlichen Betreuung rund um die Uhr und einem der größten Nachsorgenetzwerke Europas begleiten wir Sie Schritt für Schritt auf Ihrem Weg.", 'en' => "Consultation in Austria, treatment at our leading clinic in Turkey and professional aftercare across Austria, Germany and Switzerland. With 24/7 medical supervision and one of Europe's largest aftercare networks, you're supported every step of the way."]) ?>><?= apex_cms_value_or($cmsHome['hero']['sub'] ?? null, ['de' => "Persönliche Beratung in Österreich, Behandlung in unserer führenden Klinik in der Türkei und professionelle Nachsorge in Österreich, Deutschland und der Schweiz. Mit einer ärztlichen Betreuung rund um die Uhr und einem der größten Nachsorgenetzwerke Europas begleiten wir Sie Schritt für Schritt auf Ihrem Weg.", 'en' => "Consultation in Austria, treatment at our leading clinic in Turkey and professional aftercare across Austria, Germany and Switzerland. With 24/7 medical supervision and one of Europe's largest aftercare networks, you're supported every step of the way."], $currentLang) ?></p>
      <p class="hero-sub hero-sub-mobile" data-ckey="hero.t1"<?= apex_cms_attrs_or($cmsHome['hero']['t1'] ?? null, ['de' => "Persönliche Beratung in Österreich, Behandlung in unserer führenden Klinik in der Türkei und professionelle Nachsorge in Österreich, Deutschland und der Schweiz.", 'en' => "Consultation in Austria, treatment at our leading clinic in Turkey and professional aftercare across Austria, Germany and Switzerland.", 'fr' => "Consultation en Autriche, traitement dans notre clinique de référence en Turquie et suivi professionnel en Autriche, en Allemagne et en Suisse.", 'nl' => "Consult in Oostenrijk, behandeling in onze toonaangevende kliniek in Turkije en professionele nazorg in Oostenrijk, Duitsland en Zwitserland.", 'it' => "Consulenza in Austria, trattamento presso la nostra clinica leader in Turchia e assistenza post-operatoria professionale in Austria, Germania e Svizzera.", 'tr' => "Avusturya'da danışmanlık, Türkiye'deki lider kliniğimizde tedavi ve Avusturya, Almanya ve İsviçre genelinde profesyonel bakım sonrası destek."]) ?>><?= apex_cms_value_or($cmsHome['hero']['t1'] ?? null, ['de' => "Persönliche Beratung in Österreich, Behandlung in unserer führenden Klinik in der Türkei und professionelle Nachsorge in Österreich, Deutschland und der Schweiz.", 'en' => "Consultation in Austria, treatment at our leading clinic in Turkey and professional aftercare across Austria, Germany and Switzerland.", 'fr' => "Consultation en Autriche, traitement dans notre clinique de référence en Turquie et suivi professionnel en Autriche, en Allemagne et en Suisse.", 'nl' => "Consult in Oostenrijk, behandeling in onze toonaangevende kliniek in Turkije en professionele nazorg in Oostenrijk, Duitsland en Zwitserland.", 'it' => "Consulenza in Austria, trattamento presso la nostra clinica leader in Turchia e assistenza post-operatoria professionale in Austria, Germania e Svizzera.", 'tr' => "Avusturya'da danışmanlık, Türkiye'deki lider kliniğimizde tedavi ve Avusturya, Almanya ve İsviçre genelinde profesyonel bakım sonrası destek."], $currentLang) ?></p>
      <div class="hero-ctas">
        <a href="#" class="cta-btn" data-click="open-consult" data-ckey="hero.ctaPrimary"<?= apex_cms_attrs_or($cmsHome['hero']['ctaPrimary'] ?? null, ['de' => "Kostenlose Beratung sichern", 'en' => "Get your free consultation"]) ?>><?= apex_cms_value_or($cmsHome['hero']['ctaPrimary'] ?? null, ['de' => "Kostenlose Beratung sichern", 'en' => "Get your free consultation"], $currentLang) ?></a>
        <a href="#before-after" class="cta-ghost" data-ckey="hero.ctaSecondary"<?= apex_cms_attrs_or($cmsHome['hero']['ctaSecondary'] ?? null, ['de' => "Vorher-Nachher ansehen", 'en' => "See before &amp; after"]) ?>><?= apex_cms_value_or($cmsHome['hero']['ctaSecondary'] ?? null, ['de' => "Vorher-Nachher ansehen", 'en' => "See before &amp; after"], $currentLang) ?></a>
      </div>
      <div class="hero-microtrust" id="heroMicrotrust" data-clist="hero.trustPills">
        ...
        <div class="trust-pill tp-pink">
          ...
          <span data-ckey="hero.t2"<?= apex_cms_attrs_or($cmsHome['hero']['t2'] ?? null, ['de' => "Individuelles Haarlinien-Design", 'en' => "Personalized Hairline Design", 'fr' => "Conception personnalisée de la ligne capillaire", 'nl' => "Persoonlijk ontwerp van de haarlijn", 'it' => "Design personalizzato dell'attaccatura", 'tr' => "Kişiye Özel Saç Çizgisi Tasarımı"]) ?>><?= apex_cms_value_or($cmsHome['hero']['t2'] ?? null, ['de' => "Individuelles Haarlinien-Design", 'en' => "Personalized Hairline Design", 'fr' => "Conception personnalisée de la ligne capillaire", 'nl' => "Persoonlijk ontwerp van de haarlijn", 'it' => "Design personalizzato dell'attaccatura", 'tr' => "Kişiye Özel Saç Çizgisi Tasarımı"], $currentLang) ?></span>
        </div>
        <div class="trust-pill tp-teal">
          ...
          <span data-ckey="hero.t3"<?= apex_cms_attrs_or($cmsHome['hero']['t3'] ?? null, ['de' => "Stressfreie Sedierung", 'en' => "Stress-Free Sedation", 'fr' => "Sédation sans stress", 'nl' => "Stressvrije sedatie", 'it' => "Sedazione senza stress", 'tr' => "Stressiz Sedasyon"]) ?>><?= apex_cms_value_or($cmsHome['hero']['t3'] ?? null, ['de' => "Stressfreie Sedierung", 'en' => "Stress-Free Sedation", 'fr' => "Sédation sans stress", 'nl' => "Stressvrije sedatie", 'it' => "Sedazione senza stress", 'tr' => "Stressiz Sedasyon"], $currentLang) ?></span>
        </div>
      </div>
    </div>
    <div class="hero-visual">
      ...
      <a href="#network" class="float-card fc-1">
        ...
        <div><span data-ckey="hero.t4"<?= apex_cms_attrs_or($cmsHome['hero']['t4'] ?? null, ['de' => "360°-Betreuung", 'en' => "360° Care", 'fr' => "Soins 360°", 'nl' => "360° Zorg", 'it' => "Cura 360°", 'tr' => "360° Bakım"]) ?>><?= apex_cms_value_or($cmsHome['hero']['t4'] ?? null, ['de' => "360°-Betreuung", 'en' => "360° Care", 'fr' => "Soins 360°", 'nl' => "360° Zorg", 'it' => "Cura 360°", 'tr' => "360° Bakım"], $currentLang) ?></span><br><span class="u-05" data-ckey="hero.t5"<?= apex_cms_attrs_or($cmsHome['hero']['t5'] ?? null, ['de' => "Beratung bis Nachsorge", 'en' => "Consultation to Aftercare", 'fr' => "De la consultation au suivi", 'nl' => "Van consult tot nazorg", 'it' => "Dalla consulenza all'assistenza post-operatoria", 'tr' => "Danışmadan Bakıma"]) ?>><?= apex_cms_value_or($cmsHome['hero']['t5'] ?? null, ['de' => "Beratung bis Nachsorge", 'en' => "Consultation to Aftercare", 'fr' => "De la consultation au suivi", 'nl' => "Van consult tot nazorg", 'it' => "Dalla consulenza all'assistenza post-operatoria", 'tr' => "Danışmadan Bakıma"], $currentLang) ?></span></div>
      </a>
      <a class="float-card fc-2" href="https://www.google.com/maps/place/Apex+Beauty+%C3%84sthetische+Chirurgie,+Medizin+Tourismus/@48.3014502,14.2879031,17z/data=!3m1!4b1!4m6!3m5!1s0x47739758cfdf6873:0x1802fb70cbb5f96d!8m2!3d48.3014502!4d14.290478!16s%2Fg%2F11h84lrbht?hl=de&entry=ttu&g_ep=EgoyMDI2MDYyOC4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer">
        ...
        <div>
          ...
          <span>4.9 </span><span class="u-05" data-ckey="hero.t6"<?= apex_cms_attrs_or($cmsHome['hero']['t6'] ?? null, ['de' => "Google-Bewertungen", 'en' => "Google Reviews", 'fr' => "Avis Google", 'nl' => "Google-recensies", 'it' => "Recensioni Google", 'tr' => "Google Yorumları"]) ?>><?= apex_cms_value_or($cmsHome['hero']['t6'] ?? null, ['de' => "Google-Bewertungen", 'en' => "Google Reviews", 'fr' => "Avis Google", 'nl' => "Google-recensies", 'it' => "Recensioni Google", 'tr' => "Google Yorumları"], $currentLang) ?></span>
        </div>
      </a>
    </div>
  </div>
...
<section class="trust-bar">
  <div class="trust-inner">
    <div class="trust-item">
      ...
      <div><div class="trust-num"><span class="cnt" data-target="12000">0</span>+</div><div class="trust-label" data-ckey="trustBar.stat1Label"<?= apex_cms_attrs_or($cmsHome['trustBar']['stat1Label'] ?? null, ['de' => "Patienten Behandelt", 'en' => "Patients Treated"]) ?>><?= apex_cms_value_or($cmsHome['trustBar']['stat1Label'] ?? null, ['de' => "Patienten Behandelt", 'en' => "Patients Treated"], $currentLang) ?></div></div>
    </div>
    <div class="trust-item">
      ...
      <div><div class="trust-num"><span class="cnt" data-target="4.9" data-decimals="1">0</span> / 5</div><div class="trust-label" data-ckey="trustBar.stat2Label"<?= apex_cms_attrs_or($cmsHome['trustBar']['stat2Label'] ?? null, ['de' => "Google-Bewertungen", 'en' => "Google Reviews", 'fr' => "Avis Google", 'nl' => "Google-recensies", 'it' => "Recensioni Google", 'tr' => "Google Yorumları"]) ?>><?= apex_cms_value_or($cmsHome['trustBar']['stat2Label'] ?? null, ['de' => "Google-Bewertungen", 'en' => "Google Reviews", 'fr' => "Avis Google", 'nl' => "Google-recensies", 'it' => "Recensioni Google", 'tr' => "Google Yorumları"], $currentLang) ?></div></div>
    </div>
    <div class="trust-item">
      ...
      <div><div class="trust-num"><span class="cnt" data-target="15">0</span> <span data-ckey="trustBar.stat3Unit"<?= apex_cms_attrs_or($cmsHome['trustBar']['stat3Unit'] ?? null, ['de' => "Jahre", 'en' => "Years"]) ?>><?= apex_cms_value_or($cmsHome['trustBar']['stat3Unit'] ?? null, ['de' => "Jahre", 'en' => "Years"], $currentLang) ?></span></div><div class="trust-label" data-ckey="trustBar.stat3Label"<?= apex_cms_attrs_or($cmsHome['trustBar']['stat3Label'] ?? null, ['de' => "Klinische Erfahrung", 'en' => "Clinical Experience"]) ?>><?= apex_cms_value_or($cmsHome['trustBar']['stat3Label'] ?? null, ['de' => "Klinische Erfahrung", 'en' => "Clinical Experience"], $currentLang) ?></div></div>
    </div>
    <div class="trust-item">
      ...
      <div><div class="trust-num" data-ckey="trustBar.stat4Main"<?= apex_cms_attrs_or($cmsHome['trustBar']['stat4Main'] ?? null, ['de' => "Größtes Netzwerk", 'en' => "Largest Network"]) ?>><?= apex_cms_value_or($cmsHome['trustBar']['stat4Main'] ?? null, ['de' => "Größtes Netzwerk", 'en' => "Largest Network"], $currentLang) ?></div><div class="trust-label" data-ckey="trustBar.stat4Label"<?= apex_cms_attrs_or($cmsHome['trustBar']['stat4Label'] ?? null, ['de' => "Für Nachsorge in AT · DE · CH", 'en' => "For Aftercare in AT · DE · CH"]) ?>><?= apex_cms_value_or($cmsHome['trustBar']['stat4Label'] ?? null, ['de' => "Für Nachsorge in AT · DE · CH", 'en' => "For Aftercare in AT · DE · CH"], $currentLang) ?></div></div>
    </div>
  </div>
</section>
...
<section class="service" id="promiseSection">
  ...
  <div class="service-inner">
    <div class="service-head">
      <span class="service-kicker" data-ckey="promisesection.t1"<?= apex_cms_attrs_or($cmsHome['promisesection']['t1'] ?? null, ['de' => "Unser Versprechen", 'en' => "Our promise", 'fr' => "Notre promesse", 'nl' => "Onze belofte", 'it' => "La nostra promessa", 'tr' => "Sözümüz"]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t1'] ?? null, ['de' => "Unser Versprechen", 'en' => "Our promise", 'fr' => "Notre promesse", 'nl' => "Onze belofte", 'it' => "La nostra promessa", 'tr' => "Sözümüz"], $currentLang) ?></span>
      <h2 data-ckey="promise.heading"<?= apex_cms_attrs_or($cmsHome['promise']['heading'] ?? null, ['de' => "Kein Bruch zwischen Beratung, Behandlung und Nachsorge", 'en' => "No gap between consultation, treatment and aftercare"]) ?>><?= apex_cms_value_or($cmsHome['promise']['heading'] ?? null, ['de' => "Kein Bruch zwischen Beratung, Behandlung und Nachsorge", 'en' => "No gap between consultation, treatment and aftercare"], $currentLang) ?></h2>
      <p data-ckey="promise.sub"<?= apex_cms_attrs_or($cmsHome['promise']['sub'] ?? null, ['de' => "Die meisten Patienten fürchten sich nicht vor der Operation, sondern davor, was passiert, wenn sie wieder zuhause sind. Deshalb begleiten wir Sie durchgehend, nicht nur am Tag des Eingriffs.", 'en' => "Most patients aren't afraid of the procedure itself. They're afraid of what happens once they're back home. That's why we stay with you the whole way, not just on treatment day."]) ?>><?= apex_cms_value_or($cmsHome['promise']['sub'] ?? null, ['de' => "Die meisten Patienten fürchten sich nicht vor der Operation, sondern davor, was passiert, wenn sie wieder zuhause sind. Deshalb begleiten wir Sie durchgehend, nicht nur am Tag des Eingriffs.", 'en' => "Most patients aren't afraid of the procedure itself. They're afraid of what happens once they're back home. That's why we stay with you the whole way, not just on treatment day."], $currentLang) ?></p>
    </div>
    <div class="service-steps">
      <div class="step-card s1">
        <div class="step-num">1</div>
        <div class="step-text">
          <div class="step-flag" data-ckey="promisesection.t2"<?= apex_cms_attrs_or($cmsHome['promisesection']['t2'] ?? null, ['de' => "Österreich", 'en' => "Austria", 'fr' => "Autriche", 'nl' => "Oostenrijk", 'it' => "Austria", 'tr' => "Avusturya"]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t2'] ?? null, ['de' => "Österreich", 'en' => "Austria", 'fr' => "Autriche", 'nl' => "Oostenrijk", 'it' => "Austria", 'tr' => "Avusturya"], $currentLang) ?></div>
          <h3 data-ckey="promisesection.t3"<?= apex_cms_attrs_or($cmsHome['promisesection']['t3'] ?? null, ['de' => "Persönliche Beratung", 'en' => "Personal consultation", 'fr' => "Consultation personnelle", 'nl' => "Persoonlijk consult", 'it' => "Consulenza personale", 'tr' => "Kişisel Danışma"]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t3'] ?? null, ['de' => "Persönliche Beratung", 'en' => "Personal consultation", 'fr' => "Consultation personnelle", 'nl' => "Persoonlijk consult", 'it' => "Consulenza personale", 'tr' => "Kişisel Danışma"], $currentLang) ?></h3>
          <p data-ckey="promisesection.t4"<?= apex_cms_attrs_or($cmsHome['promisesection']['t4'] ?? null, ['de' => "Ihr erstes Gespräch findet vor Ort statt, nicht per anonymem Chat. Wir klären Erwartungen, Methode und Ablauf, bevor Sie reisen.", 'en' => "Your first conversation happens in person, not through an anonymous chat. We clarify expectations, method and process before you travel.", 'fr' => "Votre première conversation a lieu en personne, pas via un chat anonyme. Nous clarifions les attentes, la méthode et le déroulement avant votre voyage.", 'nl' => "Uw eerste gesprek vindt persoonlijk plaats, niet via een anonieme chat. We verduidelijken verwachtingen, methode en proces voordat u reist.", 'it' => "La tua prima conversazione avviene di persona, non tramite una chat anonima. Chiariamo aspettative, metodo e procedura prima del tuo viaggio.", 'tr' => "İlk görüşmeniz anonim bir sohbet üzerinden değil, yüz yüze gerçekleşir. Seyahat etmeden önce beklentileri, yöntemi ve süreci netleştiririz."]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t4'] ?? null, ['de' => "Ihr erstes Gespräch findet vor Ort statt, nicht per anonymem Chat. Wir klären Erwartungen, Methode und Ablauf, bevor Sie reisen.", 'en' => "Your first conversation happens in person, not through an anonymous chat. We clarify expectations, method and process before you travel.", 'fr' => "Votre première conversation a lieu en personne, pas via un chat anonyme. Nous clarifions les attentes, la méthode et le déroulement avant votre voyage.", 'nl' => "Uw eerste gesprek vindt persoonlijk plaats, niet via een anonieme chat. We verduidelijken verwachtingen, methode en proces voordat u reist.", 'it' => "La tua prima conversazione avviene di persona, non tramite una chat anonima. Chiariamo aspettative, metodo e procedura prima del tuo viaggio.", 'tr' => "İlk görüşmeniz anonim bir sohbet üzerinden değil, yüz yüze gerçekleşir. Seyahat etmeden önce beklentileri, yöntemi ve süreci netleştiririz."], $currentLang) ?></p>
        </div>
      </div>
      <div class="step-card s2">
        <div class="step-num">2</div>
        <div class="step-text">
          <div class="step-flag" data-ckey="promisesection.t5"<?= apex_cms_attrs_or($cmsHome['promisesection']['t5'] ?? null, ['de' => "Hauptklinik Istanbul", 'en' => "Main clinic, Istanbul", 'fr' => "Clinique principale, Istanbul", 'nl' => "Hoofdkliniek, Istanboel", 'it' => "Clinica principale, Istanbul", 'tr' => "Ana Klinik, İstanbul"]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t5'] ?? null, ['de' => "Hauptklinik Istanbul", 'en' => "Main clinic, Istanbul", 'fr' => "Clinique principale, Istanbul", 'nl' => "Hoofdkliniek, Istanboel", 'it' => "Clinica principale, Istanbul", 'tr' => "Ana Klinik, İstanbul"], $currentLang) ?></div>
          <h3 data-ckey="promisesection.t6"<?= apex_cms_attrs_or($cmsHome['promisesection']['t6'] ?? null, ['de' => "Behandlung mit 24/7-Betreuung", 'en' => "Treatment with 24/7 care", 'fr' => "Traitement avec soins 24h/24 et 7j/7", 'nl' => "Behandeling met 24/7 zorg", 'it' => "Trattamento con assistenza 24 ore su 24", 'tr' => "7/24 Bakımla Tedavi"]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t6'] ?? null, ['de' => "Behandlung mit 24/7-Betreuung", 'en' => "Treatment with 24/7 care", 'fr' => "Traitement avec soins 24h/24 et 7j/7", 'nl' => "Behandeling met 24/7 zorg", 'it' => "Trattamento con assistenza 24 ore su 24", 'tr' => "7/24 Bakımla Tedavi"], $currentLang) ?></h3>
          <p data-ckey="promisesection.t7"<?= apex_cms_attrs_or($cmsHome['promisesection']['t7'] ?? null, ['de' => "Die Transplantation findet in unserer Hauptklinik statt, mit durchgehender ärztlicher Betreuung, nicht nur während des Eingriffs selbst.", 'en' => "The transplant takes place at our main clinic, with continuous medical supervision, not just during the procedure itself.", 'fr' => "La greffe a lieu dans notre clinique principale, avec une supervision médicale continue, pas seulement pendant l'intervention elle-même.", 'nl' => "De transplantatie vindt plaats in onze hoofdkliniek, met continu medisch toezicht, niet alleen tijdens de ingreep zelf.", 'it' => "Il trapianto avviene presso la nostra clinica principale, con supervisione medica continua, non solo durante l'intervento stesso.", 'tr' => "Nakil, yalnızca işlem sırasında değil, sürekli tıbbi gözetim altında ana kliniğimizde gerçekleştirilir."]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t7'] ?? null, ['de' => "Die Transplantation findet in unserer Hauptklinik statt, mit durchgehender ärztlicher Betreuung, nicht nur während des Eingriffs selbst.", 'en' => "The transplant takes place at our main clinic, with continuous medical supervision, not just during the procedure itself.", 'fr' => "La greffe a lieu dans notre clinique principale, avec une supervision médicale continue, pas seulement pendant l'intervention elle-même.", 'nl' => "De transplantatie vindt plaats in onze hoofdkliniek, met continu medisch toezicht, niet alleen tijdens de ingreep zelf.", 'it' => "Il trapianto avviene presso la nostra clinica principale, con supervisione medica continua, non solo durante l'intervento stesso.", 'tr' => "Nakil, yalnızca işlem sırasında değil, sürekli tıbbi gözetim altında ana kliniğimizde gerçekleştirilir."], $currentLang) ?></p>
        </div>
      </div>
      <div class="step-card s3">
        <div class="step-num">3</div>
        <div class="step-text">
          <div class="step-flag" data-ckey="promisesection.t8"<?= apex_cms_attrs_or($cmsHome['promisesection']['t8'] ?? null, ['de' => "AT · DE · CH Netzwerk", 'en' => "AT · DE · CH network", 'fr' => "Réseau AT · DE · CH", 'nl' => "AT · DE · CH netwerk", 'it' => "Rete AT · DE · CH", 'tr' => "AT · DE · CH Ağı"]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t8'] ?? null, ['de' => "AT · DE · CH Netzwerk", 'en' => "AT · DE · CH network", 'fr' => "Réseau AT · DE · CH", 'nl' => "AT · DE · CH netwerk", 'it' => "Rete AT · DE · CH", 'tr' => "AT · DE · CH Ağı"], $currentLang) ?></div>
          <h3 data-ckey="promisesection.t9"<?= apex_cms_attrs_or($cmsHome['promisesection']['t9'] ?? null, ['de' => "Nachsorge in Ihrer Nähe", 'en' => "Aftercare near you", 'fr' => "Un suivi près de chez vous", 'nl' => "Nazorg bij u in de buurt", 'it' => "Assistenza post-operatoria vicino a te", 'tr' => "Yakınınızda Bakım"]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t9'] ?? null, ['de' => "Nachsorge in Ihrer Nähe", 'en' => "Aftercare near you", 'fr' => "Un suivi près de chez vous", 'nl' => "Nazorg bij u in de buurt", 'it' => "Assistenza post-operatoria vicino a te", 'tr' => "Yakınınızda Bakım"], $currentLang) ?></h3>
          <p data-ckey="promisesection.t10"<?= apex_cms_attrs_or($cmsHome['promisesection']['t10'] ?? null, ['de' => "Zurück zuhause endet die Betreuung nicht: unser Kliniknetzwerk in Österreich, Deutschland und der Schweiz übernimmt die Nachsorge, von Medikamenten bis PRP-Behandlungen.", 'en' => "Care doesn't end once you're home: our clinic network in Austria, Germany and Switzerland handles aftercare, from medication to PRP treatments.", 'fr' => "Le suivi ne s'arrête pas une fois rentré chez vous : notre réseau de cliniques en Autriche, en Allemagne et en Suisse assure le suivi, des médicaments aux traitements PRP.", 'nl' => "De zorg stopt niet zodra u weer thuis bent: ons klinieknetwerk in Oostenrijk, Duitsland en Zwitserland verzorgt de nazorg, van medicatie tot PRP-behandelingen.", 'it' => "L'assistenza non finisce una volta tornati a casa: la nostra rete di cliniche in Austria, Germania e Svizzera si occupa dell'assistenza post-operatoria, dai farmaci ai trattamenti PRP.", 'tr' => "Bakım, eve döndüğünüzde sona ermez: Avusturya, Almanya ve İsviçre'deki klinik ağımız, ilaçlardan PRP tedavilerine kadar bakım sonrası süreci yönetir."]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t10'] ?? null, ['de' => "Zurück zuhause endet die Betreuung nicht: unser Kliniknetzwerk in Österreich, Deutschland und der Schweiz übernimmt die Nachsorge, von Medikamenten bis PRP-Behandlungen.", 'en' => "Care doesn't end once you're home: our clinic network in Austria, Germany and Switzerland handles aftercare, from medication to PRP treatments.", 'fr' => "Le suivi ne s'arrête pas une fois rentré chez vous : notre réseau de cliniques en Autriche, en Allemagne et en Suisse assure le suivi, des médicaments aux traitements PRP.", 'nl' => "De zorg stopt niet zodra u weer thuis bent: ons klinieknetwerk in Oostenrijk, Duitsland en Zwitserland verzorgt de nazorg, van medicatie tot PRP-behandelingen.", 'it' => "L'assistenza non finisce una volta tornati a casa: la nostra rete di cliniche in Austria, Germania e Svizzera si occupa dell'assistenza post-operatoria, dai farmaci ai trattamenti PRP.", 'tr' => "Bakım, eve döndüğünüzde sona ermez: Avusturya, Almanya ve İsviçre'deki klinik ağımız, ilaçlardan PRP tedavilerine kadar bakım sonrası süreci yönetir."], $currentLang) ?></p>
        </div>
      </div>
    </div>
    <div class="service-foot">
      <span data-ckey="promisesection.t11"<?= apex_cms_attrs_or($cmsHome['promisesection']['t11'] ?? null, ['de' => "Ein Anbieter, drei Länder, ein durchgehendes Betreuungsmodell.", 'en' => "One provider, three countries, one continuous model of care.", 'fr' => "Un seul prestataire, trois pays, un modèle de soins continu.", 'nl' => "Eén aanbieder, drie landen, één doorlopend zorgmodel.", 'it' => "Un unico fornitore, tre paesi, un modello di assistenza continua.", 'tr' => "Tek sağlayıcı, üç ülke, kesintisiz bir bakım modeli."]) ?>><?= apex_cms_value_or($cmsHome['promisesection']['t11'] ?? null, ['de' => "Ein Anbieter, drei Länder, ein durchgehendes Betreuungsmodell.", 'en' => "One provider, three countries, one continuous model of care.", 'fr' => "Un seul prestataire, trois pays, un modèle de soins continu.", 'nl' => "Eén aanbieder, drie landen, één doorlopend zorgmodel.", 'it' => "Un unico fornitore, tre paesi, un modello di assistenza continua.", 'tr' => "Tek sağlayıcı, üç ülke, kesintisiz bir bakım modeli."], $currentLang) ?></span>
    </div>
  </div>
</section>
...
<section class="ba-section" id="before-after">
  ...
  <div class="ba-inner">
    <div class="ba-head">
      <span class="ba-kicker" data-ckey="beforeAfter.t1"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t1'] ?? null, ['de' => "Vorher &amp; Nachher", 'en' => "Before &amp; after", 'fr' => "Avant/après", 'nl' => "Voor en na", 'it' => "Prima e dopo", 'tr' => "Öncesi ve Sonrası"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t1'] ?? null, ['de' => "Vorher &amp; Nachher", 'en' => "Before &amp; after", 'fr' => "Avant/après", 'nl' => "Voor en na", 'it' => "Prima e dopo", 'tr' => "Öncesi ve Sonrası"], $currentLang) ?></span>
      <h2><span data-ckey="beforeAfter.heading1"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['heading1'] ?? null, ['de' => "Jeder Haaransatz.", 'en' => "Every hairline."]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['heading1'] ?? null, ['de' => "Jeder Haaransatz.", 'en' => "Every hairline."], $currentLang) ?></span> <span class="hl" data-ckey="beforeAfter.heading2"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['heading2'] ?? null, ['de' => "Mit Präzision gestaltet.", 'en' => "Designed with precision."]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['heading2'] ?? null, ['de' => "Mit Präzision gestaltet.", 'en' => "Designed with precision."], $currentLang) ?></span></h2>
      <p data-ckey="beforeAfter.sub"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['sub'] ?? null, ['de' => "Jeder Fall beginnt mit einer Kopfhaut-Analyse und endet mit einem Ergebnis, das individuell geplant wurde.", 'en' => "Every case starts with a scalp analysis and ends with a result that was planned individually."]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['sub'] ?? null, ['de' => "Jeder Fall beginnt mit einer Kopfhaut-Analyse und endet mit einem Ergebnis, das individuell geplant wurde.", 'en' => "Every case starts with a scalp analysis and ends with a result that was planned individually."], $currentLang) ?></p>
    </div>
        ...
        <div class="ba-slide active" data-citem data-slide="0">
          <div class="ba-compare">
            <div class="ba-photo ba-before">
              <span class="ba-tag" data-ckey="beforeAfter.t2"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t2'] ?? null, ['de' => "VORHER", 'en' => "BEFORE", 'fr' => "AVANT", 'nl' => "VOOR", 'it' => "PRIMA", 'tr' => "ÖNCESİ"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t2'] ?? null, ['de' => "VORHER", 'en' => "BEFORE", 'fr' => "AVANT", 'nl' => "VOOR", 'it' => "PRIMA", 'tr' => "ÖNCESİ"], $currentLang) ?></span>
              ...
              <div class="ba-callout">
                ...
                <div>
                  <b data-ckey="beforeAfter.t3"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t3'] ?? null, ['de' => "Kopfhaut-Analyse", 'en' => "Scalp analysis", 'fr' => "Analyse du cuir chevelu", 'nl' => "Hoofdhuidanalyse", 'it' => "Analisi del cuoio capelluto", 'tr' => "Saç Derisi Analizi"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t3'] ?? null, ['de' => "Kopfhaut-Analyse", 'en' => "Scalp analysis", 'fr' => "Analyse du cuir chevelu", 'nl' => "Hoofdhuidanalyse", 'it' => "Analisi del cuoio capelluto", 'tr' => "Saç Derisi Analizi"], $currentLang) ?></b>
            ...
            <div class="ba-photo ba-after">
              <span class="ba-tag" data-ckey="beforeAfter.t4"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t4'] ?? null, ['de' => "NACHHER", 'en' => "AFTER", 'fr' => "APRÈS", 'nl' => "NA", 'it' => "DOPO", 'tr' => "SONRASI"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t4'] ?? null, ['de' => "NACHHER", 'en' => "AFTER", 'fr' => "APRÈS", 'nl' => "NA", 'it' => "DOPO", 'tr' => "SONRASI"], $currentLang) ?></span>
              <div class="ba-photo-frame">
              ...
              <div class="ba-callout">
                ...
                <div>
                  <b data-ckey="beforeAfter.t5"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t5'] ?? null, ['de' => "Präzises Ergebnis", 'en' => "Precise result", 'fr' => "Résultat précis", 'nl' => "Precies resultaat", 'it' => "Risultato preciso", 'tr' => "Hassas Sonuç"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t5'] ?? null, ['de' => "Präzises Ergebnis", 'en' => "Precise result", 'fr' => "Résultat précis", 'nl' => "Precies resultaat", 'it' => "Risultato preciso", 'tr' => "Hassas Sonuç"], $currentLang) ?></b>
    ...
    <div class="ba-features">
      <div class="ba-feature">
        ...
        <div>
          <b data-ckey="beforeAfter.t6"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t6'] ?? null, ['de' => "Mit Erfahrung gestaltet", 'en' => "Shaped by experience", 'fr' => "Façonné par l'expérience", 'nl' => "Gevormd door ervaring", 'it' => "Plasmato dall'esperienza", 'tr' => "Deneyimle Şekillendi"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t6'] ?? null, ['de' => "Mit Erfahrung gestaltet", 'en' => "Shaped by experience", 'fr' => "Façonné par l'expérience", 'nl' => "Gevormd door ervaring", 'it' => "Plasmato dall'esperienza", 'tr' => "Deneyimle Şekillendi"], $currentLang) ?></b>
          <span data-ckey="beforeAfter.t7"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t7'] ?? null, ['de' => "Für maximale Präzision", 'en' => "For maximum precision", 'fr' => "Pour une précision maximale", 'nl' => "Voor maximale precisie", 'it' => "Per la massima precisione", 'tr' => "Maksimum Hassasiyet İçin"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t7'] ?? null, ['de' => "Für maximale Präzision", 'en' => "For maximum precision", 'fr' => "Pour une précision maximale", 'nl' => "Voor maximale precisie", 'it' => "Per la massima precisione", 'tr' => "Maksimum Hassasiyet İçin"], $currentLang) ?></span>
        </div>
      </div>
      <div class="ba-feature">
        ...
        <div>
          <b data-ckey="beforeAfter.t8"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t8'] ?? null, ['de' => "Natürliche Dichte", 'en' => "Natural density", 'fr' => "Densité naturelle", 'nl' => "Natuurlijke dichtheid", 'it' => "Densità naturale", 'tr' => "Doğal Yoğunluk"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t8'] ?? null, ['de' => "Natürliche Dichte", 'en' => "Natural density", 'fr' => "Densité naturelle", 'nl' => "Natuurlijke dichtheid", 'it' => "Densità naturale", 'tr' => "Doğal Yoğunluk"], $currentLang) ?></b>
          <span data-ckey="beforeAfter.t9"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t9'] ?? null, ['de' => "Für ein echtes Ergebnis", 'en' => "For a genuine result", 'fr' => "Pour un résultat authentique", 'nl' => "Voor een echt resultaat", 'it' => "Per un risultato autentico", 'tr' => "Gerçek Bir Sonuç İçin"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t9'] ?? null, ['de' => "Für ein echtes Ergebnis", 'en' => "For a genuine result", 'fr' => "Pour un résultat authentique", 'nl' => "Voor een echt resultaat", 'it' => "Per un risultato autentico", 'tr' => "Gerçek Bir Sonuç İçin"], $currentLang) ?></span>
        </div>
      </div>
      <div class="ba-feature">
        ...
        <div>
          <b data-ckey="beforeAfter.t10"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t10'] ?? null, ['de' => "Individuell geplant", 'en' => "Individually planned", 'fr' => "Planifié individuellement", 'nl' => "Individueel gepland", 'it' => "Pianificato individualmente", 'tr' => "Kişiye Özel Planlandı"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t10'] ?? null, ['de' => "Individuell geplant", 'en' => "Individually planned", 'fr' => "Planifié individuellement", 'nl' => "Individueel gepland", 'it' => "Pianificato individualmente", 'tr' => "Kişiye Özel Planlandı"], $currentLang) ?></b>
          <span data-ckey="beforeAfter.t11"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t11'] ?? null, ['de' => "Für langfristige Erfolge", 'en' => "For long-term success", 'fr' => "Pour un succès à long terme", 'nl' => "Voor succes op lange termijn", 'it' => "Per un successo a lungo termine", 'tr' => "Uzun Vadeli Başarı İçin"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t11'] ?? null, ['de' => "Für langfristige Erfolge", 'en' => "For long-term success", 'fr' => "Pour un succès à long terme", 'nl' => "Voor succes op lange termijn", 'it' => "Per un successo a lungo termine", 'tr' => "Uzun Vadeli Başarı İçin"], $currentLang) ?></span>
        </div>
      </div>
    </div>

    <div class="ba-cta-wrap">
      <a href="#" class="cta-btn" data-click="open-consult" data-ckey="beforeAfter.t12"<?= apex_cms_attrs_or($cmsHome['beforeAfter']['t12'] ?? null, ['de' => "Jetzt kostenlose Beratung sichern", 'en' => "Get Quote", 'fr' => "Obtenir un devis", 'nl' => "Offerte aanvragen", 'it' => "Richiedi un preventivo", 'tr' => "Teklif Al"]) ?>><?= apex_cms_value_or($cmsHome['beforeAfter']['t12'] ?? null, ['de' => "Jetzt kostenlose Beratung sichern", 'en' => "Get Quote", 'fr' => "Obtenir un devis", 'nl' => "Offerte aanvragen", 'it' => "Richiedi un preventivo", 'tr' => "Teklif Al"], $currentLang) ?></a>
    </div>
  </div>
</section>
...
<section class="network-section" id="network">
  <div class="network-inner">
    <div class="network-head">
      <span class="network-kicker" data-ckey="network.t1"<?= apex_cms_attrs_or($cmsHome['network']['t1'] ?? null, ['de' => "Unser Netzwerk", 'en' => "Our network", 'fr' => "Notre réseau", 'nl' => "Ons netwerk", 'it' => "La nostra rete", 'tr' => "Ağımız"]) ?>><?= apex_cms_value_or($cmsHome['network']['t1'] ?? null, ['de' => "Unser Netzwerk", 'en' => "Our network", 'fr' => "Notre réseau", 'nl' => "Ons netwerk", 'it' => "La nostra rete", 'tr' => "Ağımız"], $currentLang) ?></span>
      <h2 data-ckey="network.heading"<?= apex_cms_attrs_or($cmsHome['network']['heading'] ?? null, ['de' => "Ein Anbieter, verbunden über vier Länder", 'en' => "One provider, connected across four countries"]) ?>><?= apex_cms_value_or($cmsHome['network']['heading'] ?? null, ['de' => "Ein Anbieter, verbunden über vier Länder", 'en' => "One provider, connected across four countries"], $currentLang) ?></h2>
      <p data-ckey="network.sub"<?= apex_cms_attrs_or($cmsHome['network']['sub'] ?? null, ['de' => "Österreich, Deutschland und die Schweiz, verbunden mit unserer Hauptklinik in der Türkei: ein durchgehendes Betreuungsnetzwerk über vier Länder hinweg.", 'en' => "Austria, Germany and Switzerland, connecting to our main clinic in Turkey: one continuous care network spanning four countries."]) ?>><?= apex_cms_value_or($cmsHome['network']['sub'] ?? null, ['de' => "Österreich, Deutschland und die Schweiz, verbunden mit unserer Hauptklinik in der Türkei: ein durchgehendes Betreuungsnetzwerk über vier Länder hinweg.", 'en' => "Austria, Germany and Switzerland, connecting to our main clinic in Turkey: one continuous care network spanning four countries."], $currentLang) ?></p>
    </div>
    ...
    <div class="network-map" id="networkMap">
      <div class="earth-globe" id="earthGlobe" data-asset-base="/assets/earth/">
        ...
        <div class="earth-markers">
          <div class="net-node u-11" data-id="de">
            ...
            <div class="net-label lbl-above">
              ...
              <span class="role" data-ckey="network.t2"<?= apex_cms_attrs_or($cmsHome['network']['t2'] ?? null, ['de' => "Nachsorge", 'en' => "Aftercare", 'fr' => "Suivi", 'nl' => "Nazorg", 'it' => "Assistenza post-operatoria", 'tr' => "Bakım"]) ?>><?= apex_cms_value_or($cmsHome['network']['t2'] ?? null, ['de' => "Nachsorge", 'en' => "Aftercare", 'fr' => "Suivi", 'nl' => "Nazorg", 'it' => "Assistenza post-operatoria", 'tr' => "Bakım"], $currentLang) ?></span>
              <span class="desc" data-ckey="network.t3"<?= apex_cms_attrs_or($cmsHome['network']['t3'] ?? null, ['de' => "München, Teil unseres Nachsorge-Netzwerks.", 'en' => "Munich, part of our aftercare network.", 'fr' => "Munich, membre de notre réseau de suivi.", 'nl' => "München, onderdeel van ons nazorgnetwerk.", 'it' => "Monaco, parte della nostra rete di assistenza post-operatoria.", 'tr' => "Münih, bakım ağımızın bir parçasıdır."]) ?>><?= apex_cms_value_or($cmsHome['network']['t3'] ?? null, ['de' => "München, Teil unseres Nachsorge-Netzwerks.", 'en' => "Munich, part of our aftercare network.", 'fr' => "Munich, membre de notre réseau de suivi.", 'nl' => "München, onderdeel van ons nazorgnetwerk.", 'it' => "Monaco, parte della nostra rete di assistenza post-operatoria.", 'tr' => "Münih, bakım ağımızın bir parçasıdır."], $currentLang) ?></span>
            </div>
          </div>

          <div class="net-node u-12" data-id="ch">
            ...
            <div class="net-label lbl-above">
              ...
              <span class="role" data-ckey="network.t4"<?= apex_cms_attrs_or($cmsHome['network']['t4'] ?? null, ['de' => "Nachsorge", 'en' => "Aftercare", 'fr' => "Suivi", 'nl' => "Nazorg", 'it' => "Assistenza post-operatoria", 'tr' => "Bakım"]) ?>><?= apex_cms_value_or($cmsHome['network']['t4'] ?? null, ['de' => "Nachsorge", 'en' => "Aftercare", 'fr' => "Suivi", 'nl' => "Nazorg", 'it' => "Assistenza post-operatoria", 'tr' => "Bakım"], $currentLang) ?></span>
              <span class="desc" data-ckey="network.t5"<?= apex_cms_attrs_or($cmsHome['network']['t5'] ?? null, ['de' => "Zürich, Teil unseres Nachsorge-Netzwerks.", 'en' => "Zurich, part of our aftercare network.", 'fr' => "Zurich, membre de notre réseau de suivi.", 'nl' => "Zürich, onderdeel van ons nazorgnetwerk.", 'it' => "Zurigo, parte della nostra rete di assistenza post-operatoria.", 'tr' => "Zürih, bakım ağımızın bir parçasıdır."]) ?>><?= apex_cms_value_or($cmsHome['network']['t5'] ?? null, ['de' => "Zürich, Teil unseres Nachsorge-Netzwerks.", 'en' => "Zurich, part of our aftercare network.", 'fr' => "Zurich, membre de notre réseau de suivi.", 'nl' => "Zürich, onderdeel van ons nazorgnetwerk.", 'it' => "Zurigo, parte della nostra rete di assistenza post-operatoria.", 'tr' => "Zürih, bakım ağımızın bir parçasıdır."], $currentLang) ?></span>
            </div>
          </div>

          <div class="net-node nn-hub u-13" data-id="at">
            ...
            <div class="net-label lbl-above">
              ...
              <span class="role" data-ckey="network.t6"<?= apex_cms_attrs_or($cmsHome['network']['t6'] ?? null, ['de' => "Beratung &amp; Zentrale", 'en' => "Consultation &amp; HQ", 'fr' => "Consultation et siège", 'nl' => "Consult & hoofdkantoor", 'it' => "Consulenza e sede centrale", 'tr' => "Danışma ve Merkez"]) ?>><?= apex_cms_value_or($cmsHome['network']['t6'] ?? null, ['de' => "Beratung &amp; Zentrale", 'en' => "Consultation &amp; HQ", 'fr' => "Consultation et siège", 'nl' => "Consult & hoofdkantoor", 'it' => "Consulenza e sede centrale", 'tr' => "Danışma ve Merkez"], $currentLang) ?></span>
              <span class="desc" data-ckey="network.t7"<?= apex_cms_attrs_or($cmsHome['network']['t7'] ?? null, ['de' => "Linz, Ihr erstes Gespräch findet hier statt, persönlich vor Ort.", 'en' => "Linz, your first conversation happens here, in person.", 'fr' => "Linz, votre première conversation a lieu ici, en personne.", 'nl' => "Linz, uw eerste gesprek vindt hier persoonlijk plaats.", 'it' => "Linz, la tua prima conversazione avviene qui, di persona.", 'tr' => "Linz, ilk görüşmeniz burada, yüz yüze gerçekleşir."]) ?>><?= apex_cms_value_or($cmsHome['network']['t7'] ?? null, ['de' => "Linz, Ihr erstes Gespräch findet hier statt, persönlich vor Ort.", 'en' => "Linz, your first conversation happens here, in person.", 'fr' => "Linz, votre première conversation a lieu ici, en personne.", 'nl' => "Linz, uw eerste gesprek vindt hier persoonlijk plaats.", 'it' => "Linz, la tua prima conversazione avviene qui, di persona.", 'tr' => "Linz, ilk görüşmeniz burada, yüz yüze gerçekleşir."], $currentLang) ?></span>
            </div>
          </div>

          <div class="net-node u-14" data-id="tr">
            ...
            <div class="net-label lbl-above">
              ...
              <span class="role" data-ckey="network.t8"<?= apex_cms_attrs_or($cmsHome['network']['t8'] ?? null, ['de' => "Hauptklinik", 'en' => "Main clinic", 'fr' => "Clinique principale", 'nl' => "Hoofdkliniek", 'it' => "Clinica principale", 'tr' => "Ana Klinik"]) ?>><?= apex_cms_value_or($cmsHome['network']['t8'] ?? null, ['de' => "Hauptklinik", 'en' => "Main clinic", 'fr' => "Clinique principale", 'nl' => "Hoofdkliniek", 'it' => "Clinica principale", 'tr' => "Ana Klinik"], $currentLang) ?></span>
              <span class="desc" data-ckey="network.t9"<?= apex_cms_attrs_or($cmsHome['network']['t9'] ?? null, ['de' => "Istanbul, Ihre Behandlung findet hier statt, mit 24/7-Betreuung.", 'en' => "Istanbul, your treatment takes place here, with 24/7 care.", 'fr' => "Istanbul, votre traitement a lieu ici, avec des soins 24h/24 et 7j/7.", 'nl' => "Istanboel, uw behandeling vindt hier plaats, met 24/7 zorg.", 'it' => "Istanbul, il tuo trattamento avviene qui, con assistenza 24 ore su 24.", 'tr' => "İstanbul, tedaviniz burada, 7/24 bakımla gerçekleştirilir."]) ?>><?= apex_cms_value_or($cmsHome['network']['t9'] ?? null, ['de' => "Istanbul, Ihre Behandlung findet hier statt, mit 24/7-Betreuung.", 'en' => "Istanbul, your treatment takes place here, with 24/7 care.", 'fr' => "Istanbul, votre traitement a lieu ici, avec des soins 24h/24 et 7j/7.", 'nl' => "Istanboel, uw behandeling vindt hier plaats, met 24/7 zorg.", 'it' => "Istanbul, il tuo trattamento avviene qui, con assistenza 24 ore su 24.", 'tr' => "İstanbul, tedaviniz burada, 7/24 bakımla gerçekleştirilir."], $currentLang) ?></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="network-legend">
      <div class="lg-item"><span class="lg-dot"></span><span data-ckey="network.t10"<?= apex_cms_attrs_or($cmsHome['network']['t10'] ?? null, ['de' => "Live verbundenes Betreuungsnetzwerk", 'en' => "Live connected care network", 'fr' => "Réseau de soins connecté en direct", 'nl' => "Live verbonden zorgnetwerk", 'it' => "Rete di assistenza connessa in tempo reale", 'tr' => "Canlı Bağlantılı Bakım Ağı"]) ?>><?= apex_cms_value_or($cmsHome['network']['t10'] ?? null, ['de' => "Live verbundenes Betreuungsnetzwerk", 'en' => "Live connected care network", 'fr' => "Réseau de soins connecté en direct", 'nl' => "Live verbonden zorgnetwerk", 'it' => "Rete di assistenza connessa in tempo reale", 'tr' => "Canlı Bağlantılı Bakım Ağı"], $currentLang) ?></span></div>
    </div>
  </div>
</section>
...
<section class="faq-section" id="faq">
  ...
  <div class="faq-inner">
    <div class="faq-head">
      ...
      <div>
        <div class="faq-kicker" data-ckey="faq.t1"<?= apex_cms_attrs_or($cmsHome['faq']['t1'] ?? null, ['de' => "Fragen &amp; Antworten", 'en' => "Questions &amp; answers", 'fr' => "Questions et réponses", 'nl' => "Vragen & antwoorden", 'it' => "Domande e risposte", 'tr' => "Sorular ve Cevaplar"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t1'] ?? null, ['de' => "Fragen &amp; Antworten", 'en' => "Questions &amp; answers", 'fr' => "Questions et réponses", 'nl' => "Vragen & antwoorden", 'it' => "Domande e risposte", 'tr' => "Sorular ve Cevaplar"], $currentLang) ?></div>
        <h2 data-ckey="faq.heading"<?= apex_cms_attrs_or($cmsHome['faq']['heading'] ?? null, ['de' => "Häufig gestellte Fragen", 'en' => "Frequently asked questions"]) ?>><?= apex_cms_value_or($cmsHome['faq']['heading'] ?? null, ['de' => "Häufig gestellte Fragen", 'en' => "Frequently asked questions"], $currentLang) ?></h2>
        <p data-ckey="faq.t2"<?= apex_cms_attrs_or($cmsHome['faq']['t2'] ?? null, ['de' => "Die Fragen, die potenzielle Patienten am häufigsten davon abhalten, eine Beratung zu buchen, ehrlich beantwortet.", 'en' => "The questions that most often hold prospective patients back from booking a consultation, answered honestly.", 'fr' => "Les questions qui empêchent le plus souvent les futurs patients de réserver une consultation, avec des réponses honnêtes.", 'nl' => "De vragen die potentiële patiënten er het vaakst van weerhouden een consult te boeken, eerlijk beantwoord.", 'it' => "Le domande che più spesso trattengono i potenziali pazienti dal prenotare una consulenza, con risposte oneste.", 'tr' => "Potansiyel hastaları bir danışma rezervasyonu yapmaktan en çok alıkoyan sorular, dürüstçe yanıtlanmıştır."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t2'] ?? null, ['de' => "Die Fragen, die potenzielle Patienten am häufigsten davon abhalten, eine Beratung zu buchen, ehrlich beantwortet.", 'en' => "The questions that most often hold prospective patients back from booking a consultation, answered honestly.", 'fr' => "Les questions qui empêchent le plus souvent les futurs patients de réserver une consultation, avec des réponses honnêtes.", 'nl' => "De vragen die potentiële patiënten er het vaakst van weerhouden een consult te boeken, eerlijk beantwoord.", 'it' => "Le domande che più spesso trattengono i potenziali pazienti dal prenotare una consulenza, con risposte oneste.", 'tr' => "Potansiyel hastaları bir danışma rezervasyonu yapmaktan en çok alıkoyan sorular, dürüstçe yanıtlanmıştır."], $currentLang) ?></p>
        <a class="u-15" href="service-hair-transplant.php" data-ckey="faq.t3"<?= apex_cms_attrs_or($cmsHome['faq']['t3'] ?? null, ['de' => "Mehr über die Haartransplantation erfahren →", 'en' => "Learn more about hair transplantation →", 'fr' => "En savoir plus sur la greffe de cheveux →", 'nl' => "Meer weten over haartransplantatie →", 'it' => "Scopri di più sul trapianto di capelli →", 'tr' => "Saç ekimi hakkında daha fazla bilgi edinin →"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t3'] ?? null, ['de' => "Mehr über die Haartransplantation erfahren →", 'en' => "Learn more about hair transplantation →", 'fr' => "En savoir plus sur la greffe de cheveux →", 'nl' => "Meer weten over haartransplantatie →", 'it' => "Scopri di più sul trapianto di capelli →", 'tr' => "Saç ekimi hakkında daha fazla bilgi edinin →"], $currentLang) ?></a>
      </div>
    </div>

    <div class="hp-faq-list" data-clist="faq.items">
      <div class="hp-faq-item" data-citem>
        <div class="hp-faq-q" data-click="faq"><span data-cfield="question" data-de="Tut eine Haartransplantation weh?" data-en="Does a hair transplant hurt?">Tut eine Haartransplantation weh?</span><span class="plus">+</span></div>
      ...
      <div class="hp-faq-item">
        <div class="hp-faq-q" data-click="faq"><span data-ckey="faq.t4"<?= apex_cms_attrs_or($cmsHome['faq']['t4'] ?? null, ['de' => "Wird man sehen, dass ich eine Transplantation hatte?", 'en' => "Will anyone be able to tell I've had a transplant?", 'fr' => "Est-ce que cela se verra que j'ai eu une greffe ?", 'nl' => "Zal iemand kunnen zien dat ik een transplantatie heb gehad?", 'it' => "Si vedrà che ho fatto un trapianto?", 'tr' => "Saç ekimi yaptırdığım belli olur mu?"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t4'] ?? null, ['de' => "Wird man sehen, dass ich eine Transplantation hatte?", 'en' => "Will anyone be able to tell I've had a transplant?", 'fr' => "Est-ce que cela se verra que j'ai eu une greffe ?", 'nl' => "Zal iemand kunnen zien dat ik een transplantatie heb gehad?", 'it' => "Si vedrà che ho fatto un trapianto?", 'tr' => "Saç ekimi yaptırdığım belli olur mu?"], $currentLang) ?></span><span class="plus">+</span></div>
        <div class="hp-faq-a"><p data-ckey="faq.t5"<?= apex_cms_attrs_or($cmsHome['faq']['t5'] ?? null, ['de' => "In den ersten 1 bis 2 Wochen können Krusten und Rötungen sichtbar sein. Danach ist die Heilung weitgehend unsichtbar. Ab Monat 4 bis 6 verschmilzt das neue Haar natürlich mit dem vorhandenen, bei einem erfahrenen Chirurgen nicht von echtem Haar zu unterscheiden.", 'en' => "In the first 1 to 2 weeks, visible scabbing and redness may be noticeable. After that, healing is largely invisible. By months 4 to 6, the new hair blends naturally and, with an experienced surgeon, is indistinguishable from native hair.", 'fr' => "Durant les 1 à 2 premières semaines, des croûtes visibles et des rougeurs peuvent apparaître. Ensuite, la cicatrisation devient largement invisible. Entre le 4e et le 6e mois, les nouveaux cheveux se fondent naturellement et, avec un chirurgien expérimenté, deviennent indiscernables des cheveux naturels.", 'nl' => "In de eerste 1 tot 2 weken kunnen zichtbare korstjes en roodheid optreden. Daarna is de genezing grotendeels onzichtbaar. Vanaf maand 4 tot 6 vermengt het nieuwe haar zich natuurlijk en is het, bij een ervaren chirurg, niet te onderscheiden van natuurlijk haar.", 'it' => "Nelle prime 1-2 settimane possono essere visibili croste e arrossamenti. Successivamente, la guarigione diventa in gran parte invisibile. Dal 4° al 6° mese, i nuovi capelli si integrano in modo naturale e, con un chirurgo esperto, risultano indistinguibili dai capelli naturali.", 'tr' => "İlk 1-2 hafta içinde görünür kabuklanma ve kızarıklık olabilir. Bundan sonra iyileşme büyük ölçüde görünmez hale gelir. 4. ile 6. aylar arasında yeni saçlar doğal bir şekilde kaynaşır ve deneyimli bir cerrahla doğal saçtan ayırt edilemez hale gelir."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t5'] ?? null, ['de' => "In den ersten 1 bis 2 Wochen können Krusten und Rötungen sichtbar sein. Danach ist die Heilung weitgehend unsichtbar. Ab Monat 4 bis 6 verschmilzt das neue Haar natürlich mit dem vorhandenen, bei einem erfahrenen Chirurgen nicht von echtem Haar zu unterscheiden.", 'en' => "In the first 1 to 2 weeks, visible scabbing and redness may be noticeable. After that, healing is largely invisible. By months 4 to 6, the new hair blends naturally and, with an experienced surgeon, is indistinguishable from native hair.", 'fr' => "Durant les 1 à 2 premières semaines, des croûtes visibles et des rougeurs peuvent apparaître. Ensuite, la cicatrisation devient largement invisible. Entre le 4e et le 6e mois, les nouveaux cheveux se fondent naturellement et, avec un chirurgien expérimenté, deviennent indiscernables des cheveux naturels.", 'nl' => "In de eerste 1 tot 2 weken kunnen zichtbare korstjes en roodheid optreden. Daarna is de genezing grotendeels onzichtbaar. Vanaf maand 4 tot 6 vermengt het nieuwe haar zich natuurlijk en is het, bij een ervaren chirurg, niet te onderscheiden van natuurlijk haar.", 'it' => "Nelle prime 1-2 settimane possono essere visibili croste e arrossamenti. Successivamente, la guarigione diventa in gran parte invisibile. Dal 4° al 6° mese, i nuovi capelli si integrano in modo naturale e, con un chirurgo esperto, risultano indistinguibili dai capelli naturali.", 'tr' => "İlk 1-2 hafta içinde görünür kabuklanma ve kızarıklık olabilir. Bundan sonra iyileşme büyük ölçüde görünmez hale gelir. 4. ile 6. aylar arasında yeni saçlar doğal bir şekilde kaynaşır ve deneyimli bir cerrahla doğal saçtan ayırt edilemez hale gelir."], $currentLang) ?></p></div>
      </div>
      <div class="hp-faq-item">
        <div class="hp-faq-q" data-click="faq"><span data-ckey="faq.t6"<?= apex_cms_attrs_or($cmsHome['faq']['t6'] ?? null, ['de' => "Wie viele Grafts brauche ich?", 'en' => "How many grafts do I need?", 'fr' => "De combien de greffons ai-je besoin ?", 'nl' => "Hoeveel grafts heb ik nodig?", 'it' => "Di quanti innesti ho bisogno?", 'tr' => "Kaç greft ihtiyacım var?"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t6'] ?? null, ['de' => "Wie viele Grafts brauche ich?", 'en' => "How many grafts do I need?", 'fr' => "De combien de greffons ai-je besoin ?", 'nl' => "Hoeveel grafts heb ik nodig?", 'it' => "Di quanti innesti ho bisogno?", 'tr' => "Kaç greft ihtiyacım var?"], $currentLang) ?></span><span class="plus">+</span></div>
        <div class="hp-faq-a"><p data-ckey="faq.t7"<?= apex_cms_attrs_or($cmsHome['faq']['t7'] ?? null, ['de' => "Das hängt vom Ausmaß des Haarausfalls und der gewünschten Dichte ab. Eine typische Sitzung umfasst 1.500 bis 4.000 Grafts. Grad II bis III benötigt meist 1.500 bis 2.000, Grad V bis VI oft 3.000 bis 4.500. Eine kostenlose Beratung mit Haaranalyse gibt eine präzise Einschätzung.", 'en' => "This depends entirely on the degree of hair loss and desired density. A typical session ranges from 1,500 to 4,000 grafts. Grade II to III usually needs 1,500 to 2,000; grade V to VI often 3,000 to 4,500. A free consultation with scalp analysis gives an accurate estimate.", 'fr' => "Cela dépend entièrement du degré de chute de cheveux et de la densité souhaitée. Une séance typique va de 1 500 à 4 000 greffons. Le stade II à III nécessite généralement 1 500 à 2 000 ; le stade V à VI souvent 3 000 à 4 500. Une consultation gratuite avec analyse du cuir chevelu permet une estimation précise.", 'nl' => "Dit hangt volledig af van de mate van haaruitval en de gewenste dichtheid. Een gemiddelde sessie omvat 1.500 tot 4.000 grafts. Graad II tot III heeft meestal 1.500 tot 2.000 nodig; graad V tot VI vaak 3.000 tot 4.500. Een gratis consult met hoofdhuidanalyse geeft een nauwkeurige schatting.", 'it' => "Dipende interamente dal grado di caduta dei capelli e dalla densità desiderata. Una seduta tipica va da 1.500 a 4.000 innesti. Il grado II-III richiede solitamente 1.500-2.000 innesti; il grado V-VI spesso 3.000-4.500. Un consulto gratuito con analisi del cuoio capelluto fornisce una stima precisa.", 'tr' => "Bu tamamen saç dökülmesinin derecesine ve istenen yoğunluğa bağlıdır. Tipik bir seans 1.500 ile 4.000 greft arasında değişir. Derece II-III genellikle 1.500-2.000 greft gerektirir; derece V-VI ise sıklıkla 3.000-4.500 greft gerektirir. Saç derisi analizi içeren ücretsiz bir danışma, doğru bir tahmin sağlar."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t7'] ?? null, ['de' => "Das hängt vom Ausmaß des Haarausfalls und der gewünschten Dichte ab. Eine typische Sitzung umfasst 1.500 bis 4.000 Grafts. Grad II bis III benötigt meist 1.500 bis 2.000, Grad V bis VI oft 3.000 bis 4.500. Eine kostenlose Beratung mit Haaranalyse gibt eine präzise Einschätzung.", 'en' => "This depends entirely on the degree of hair loss and desired density. A typical session ranges from 1,500 to 4,000 grafts. Grade II to III usually needs 1,500 to 2,000; grade V to VI often 3,000 to 4,500. A free consultation with scalp analysis gives an accurate estimate.", 'fr' => "Cela dépend entièrement du degré de chute de cheveux et de la densité souhaitée. Une séance typique va de 1 500 à 4 000 greffons. Le stade II à III nécessite généralement 1 500 à 2 000 ; le stade V à VI souvent 3 000 à 4 500. Une consultation gratuite avec analyse du cuir chevelu permet une estimation précise.", 'nl' => "Dit hangt volledig af van de mate van haaruitval en de gewenste dichtheid. Een gemiddelde sessie omvat 1.500 tot 4.000 grafts. Graad II tot III heeft meestal 1.500 tot 2.000 nodig; graad V tot VI vaak 3.000 tot 4.500. Een gratis consult met hoofdhuidanalyse geeft een nauwkeurige schatting.", 'it' => "Dipende interamente dal grado di caduta dei capelli e dalla densità desiderata. Una seduta tipica va da 1.500 a 4.000 innesti. Il grado II-III richiede solitamente 1.500-2.000 innesti; il grado V-VI spesso 3.000-4.500. Un consulto gratuito con analisi del cuoio capelluto fornisce una stima precisa.", 'tr' => "Bu tamamen saç dökülmesinin derecesine ve istenen yoğunluğa bağlıdır. Tipik bir seans 1.500 ile 4.000 greft arasında değişir. Derece II-III genellikle 1.500-2.000 greft gerektirir; derece V-VI ise sıklıkla 3.000-4.500 greft gerektirir. Saç derisi analizi içeren ücretsiz bir danışma, doğru bir tahmin sağlar."], $currentLang) ?></p></div>
      </div>
      <div class="hp-faq-item">
        <div class="hp-faq-q" data-click="faq"><span data-ckey="faq.t8"<?= apex_cms_attrs_or($cmsHome['faq']['t8'] ?? null, ['de' => "Ist das Ergebnis dauerhaft?", 'en' => "Is the result permanent?", 'fr' => "Le résultat est-il permanent ?", 'nl' => "Is het resultaat blijvend?", 'it' => "Il risultato è permanente?", 'tr' => "Sonuç kalıcı mı?"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t8'] ?? null, ['de' => "Ist das Ergebnis dauerhaft?", 'en' => "Is the result permanent?", 'fr' => "Le résultat est-il permanent ?", 'nl' => "Is het resultaat blijvend?", 'it' => "Il risultato è permanente?", 'tr' => "Sonuç kalıcı mı?"], $currentLang) ?></span><span class="plus">+</span></div>
        <div class="hp-faq-a"><p data-ckey="faq.t9"<?= apex_cms_attrs_or($cmsHome['faq']['t9'] ?? null, ['de' => "Transplantiertes Haar stammt aus dem DHT-resistenten Spenderbereich und wächst lebenslang weiter. Nicht transplantiertes Haar kann jedoch weiter ausdünnen. Medikamente wie Finasterid oder Minoxidil nach dem Eingriff schützen das verbleibende natürliche Haar.", 'en' => "Transplanted hair is taken from the DHT-resistant donor zone and continues to grow for life. However, existing non-transplanted hair may keep thinning. Medication like finasteride or minoxidil after the procedure helps protect remaining native hair.", 'fr' => "Les cheveux transplantés proviennent de la zone donneuse résistante à la DHT et continuent de pousser à vie. Cependant, les cheveux non transplantés existants peuvent continuer à s'affiner. Des médicaments comme le finastéride ou le minoxidil après l'intervention aident à protéger les cheveux naturels restants.", 'nl' => "Getransplanteerd haar komt uit het DHT-resistente donorgebied en blijft levenslang doorgroeien. Bestaand, niet-getransplanteerd haar kan echter blijven uitdunnen. Medicatie zoals finasteride of minoxidil na de ingreep helpt het resterende natuurlijke haar te beschermen.", 'it' => "I capelli trapiantati provengono dall'area donatrice resistente al DHT e continuano a crescere per tutta la vita. Tuttavia, i capelli esistenti non trapiantati potrebbero continuare a diradarsi. Farmaci come finasteride o minoxidil dopo l'intervento aiutano a proteggere i capelli naturali rimanenti.", 'tr' => "Nakledilen saçlar DHT'ye dirençli donör bölgeden alınır ve ömür boyu büyümeye devam eder. Ancak nakledilmemiş mevcut saçlar seyrelmeye devam edebilir. İşlem sonrası finasterid veya minoksidil gibi ilaçlar, kalan doğal saçların korunmasına yardımcı olur."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t9'] ?? null, ['de' => "Transplantiertes Haar stammt aus dem DHT-resistenten Spenderbereich und wächst lebenslang weiter. Nicht transplantiertes Haar kann jedoch weiter ausdünnen. Medikamente wie Finasterid oder Minoxidil nach dem Eingriff schützen das verbleibende natürliche Haar.", 'en' => "Transplanted hair is taken from the DHT-resistant donor zone and continues to grow for life. However, existing non-transplanted hair may keep thinning. Medication like finasteride or minoxidil after the procedure helps protect remaining native hair.", 'fr' => "Les cheveux transplantés proviennent de la zone donneuse résistante à la DHT et continuent de pousser à vie. Cependant, les cheveux non transplantés existants peuvent continuer à s'affiner. Des médicaments comme le finastéride ou le minoxidil après l'intervention aident à protéger les cheveux naturels restants.", 'nl' => "Getransplanteerd haar komt uit het DHT-resistente donorgebied en blijft levenslang doorgroeien. Bestaand, niet-getransplanteerd haar kan echter blijven uitdunnen. Medicatie zoals finasteride of minoxidil na de ingreep helpt het resterende natuurlijke haar te beschermen.", 'it' => "I capelli trapiantati provengono dall'area donatrice resistente al DHT e continuano a crescere per tutta la vita. Tuttavia, i capelli esistenti non trapiantati potrebbero continuare a diradarsi. Farmaci come finasteride o minoxidil dopo l'intervento aiutano a proteggere i capelli naturali rimanenti.", 'tr' => "Nakledilen saçlar DHT'ye dirençli donör bölgeden alınır ve ömür boyu büyümeye devam eder. Ancak nakledilmemiş mevcut saçlar seyrelmeye devam edebilir. İşlem sonrası finasterid veya minoksidil gibi ilaçlar, kalan doğal saçların korunmasına yardımcı olur."], $currentLang) ?></p></div>
      </div>
      <div class="hp-faq-item">
        <div class="hp-faq-q" data-click="faq"><span data-ckey="faq.t10"<?= apex_cms_attrs_or($cmsHome['faq']['t10'] ?? null, ['de' => "Was passiert, wenn das Ergebnis nicht ausreicht?", 'en' => "What happens if I don't get enough results?", 'fr' => "Que se passe-t-il si le résultat n'est pas suffisant ?", 'nl' => "Wat gebeurt er als het resultaat onvoldoende is?", 'it' => "Cosa succede se il risultato non è sufficiente?", 'tr' => "Yeterli sonuç alamazsam ne olur?"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t10'] ?? null, ['de' => "Was passiert, wenn das Ergebnis nicht ausreicht?", 'en' => "What happens if I don't get enough results?", 'fr' => "Que se passe-t-il si le résultat n'est pas suffisant ?", 'nl' => "Wat gebeurt er als het resultaat onvoldoende is?", 'it' => "Cosa succede se il risultato non è sufficiente?", 'tr' => "Yeterli sonuç alamazsam ne olur?"], $currentLang) ?></span><span class="plus">+</span></div>
        <div class="hp-faq-a"><p data-ckey="faq.t11"<?= apex_cms_attrs_or($cmsHome['faq']['t11'] ?? null, ['de' => "Die Graft-Überlebensrate liegt bei seriösen Kliniken bei 90 bis 95%. Bleibt das Ergebnis nach 12 bis 18 Monaten unter den Erwartungen, kann eine Folgesitzung besprochen werden. Apex Beauty bietet eine Kontrolluntersuchung nach 12 Monaten an.", 'en' => "Graft survival rates at reputable clinics are generally 90 to 95%. If the result is below expectations after 12 to 18 months, a follow-up session can be discussed. Apex Beauty offers a 12-month follow-up consultation to assess the outcome.", 'fr' => "Les taux de survie des greffons dans les cliniques réputées sont généralement de 90 à 95 %. Si le résultat est inférieur aux attentes après 12 à 18 mois, une séance de suivi peut être envisagée. Apex Beauty propose une consultation de suivi à 12 mois pour évaluer le résultat.", 'nl' => "De overlevingspercentages van grafts bij gerenommeerde klinieken liggen doorgaans tussen 90 en 95%. Als het resultaat na 12 tot 18 maanden onder de verwachtingen blijft, kan een vervolgsessie worden besproken. Apex Beauty biedt een vervolgconsult na 12 maanden om het resultaat te beoordelen.", 'it' => "I tassi di sopravvivenza degli innesti nelle cliniche affidabili sono generalmente del 90-95%. Se il risultato è inferiore alle aspettative dopo 12-18 mesi, si può discutere di una seduta di follow-up. Apex Beauty offre una consulenza di controllo a 12 mesi per valutare l'esito.", 'tr' => "Saygın kliniklerde greft sağkalım oranları genellikle %90 ila %95 arasındadır. Sonuç 12-18 ay sonra beklentilerin altındaysa, bir takip seansı değerlendirilebilir. Apex Beauty, sonucu değerlendirmek için 12 aylık bir takip danışmanlığı sunar."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t11'] ?? null, ['de' => "Die Graft-Überlebensrate liegt bei seriösen Kliniken bei 90 bis 95%. Bleibt das Ergebnis nach 12 bis 18 Monaten unter den Erwartungen, kann eine Folgesitzung besprochen werden. Apex Beauty bietet eine Kontrolluntersuchung nach 12 Monaten an.", 'en' => "Graft survival rates at reputable clinics are generally 90 to 95%. If the result is below expectations after 12 to 18 months, a follow-up session can be discussed. Apex Beauty offers a 12-month follow-up consultation to assess the outcome.", 'fr' => "Les taux de survie des greffons dans les cliniques réputées sont généralement de 90 à 95 %. Si le résultat est inférieur aux attentes après 12 à 18 mois, une séance de suivi peut être envisagée. Apex Beauty propose une consultation de suivi à 12 mois pour évaluer le résultat.", 'nl' => "De overlevingspercentages van grafts bij gerenommeerde klinieken liggen doorgaans tussen 90 en 95%. Als het resultaat na 12 tot 18 maanden onder de verwachtingen blijft, kan een vervolgsessie worden besproken. Apex Beauty biedt een vervolgconsult na 12 maanden om het resultaat te beoordelen.", 'it' => "I tassi di sopravvivenza degli innesti nelle cliniche affidabili sono generalmente del 90-95%. Se il risultato è inferiore alle aspettative dopo 12-18 mesi, si può discutere di una seduta di follow-up. Apex Beauty offre una consulenza di controllo a 12 mesi per valutare l'esito.", 'tr' => "Saygın kliniklerde greft sağkalım oranları genellikle %90 ila %95 arasındadır. Sonuç 12-18 ay sonra beklentilerin altındaysa, bir takip seansı değerlendirilebilir. Apex Beauty, sonucu değerlendirmek için 12 aylık bir takip danışmanlığı sunar."], $currentLang) ?></p></div>
      </div>
      <div class="hp-faq-item">
        <div class="hp-faq-q" data-click="faq"><span data-ckey="faq.t12"<?= apex_cms_attrs_or($cmsHome['faq']['t12'] ?? null, ['de' => "Können Frauen eine Haartransplantation bekommen?", 'en' => "Can women have hair transplants?", 'fr' => "Les femmes peuvent-elles avoir une greffe de cheveux ?", 'nl' => "Kunnen vrouwen een haartransplantatie ondergaan?", 'it' => "Le donne possono sottoporsi a trapianto di capelli?", 'tr' => "Kadınlar saç ekimi yaptırabilir mi?"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t12'] ?? null, ['de' => "Können Frauen eine Haartransplantation bekommen?", 'en' => "Can women have hair transplants?", 'fr' => "Les femmes peuvent-elles avoir une greffe de cheveux ?", 'nl' => "Kunnen vrouwen een haartransplantatie ondergaan?", 'it' => "Le donne possono sottoporsi a trapianto di capelli?", 'tr' => "Kadınlar saç ekimi yaptırabilir mi?"], $currentLang) ?></span><span class="plus">+</span></div>
        <div class="hp-faq-a"><p data-ckey="faq.t13"<?= apex_cms_attrs_or($cmsHome['faq']['t13'] ?? null, ['de' => "Ja. Frauen mit androgenetischer Alopezie können geeignete Kandidatinnen sein. Bei diffusem Haarausfall über die gesamte Kopfhaut, einschließlich des Spenderbereichs, reicht die stabile Spenderdichte jedoch oft nicht aus. Eine fachärztliche Beurteilung ist essenziell.", 'en' => "Yes. Women with androgenetic alopecia can be suitable candidates. However, women with diffuse hair loss across the entire scalp, including the donor area, may not have sufficient stable donor hair. A specialist assessment is essential.", 'fr' => "Oui. Les femmes atteintes d'alopécie androgénétique peuvent être de bonnes candidates. Cependant, les femmes présentant une chute de cheveux diffuse sur l'ensemble du cuir chevelu, y compris la zone donneuse, peuvent ne pas disposer d'assez de cheveux donneurs stables. Une évaluation par un spécialiste est essentielle.", 'nl' => "Ja. Vrouwen met androgenetische alopecia kunnen geschikte kandidaten zijn. Vrouwen met diffuse haaruitval over de hele hoofdhuid, inclusief het donorgebied, hebben echter mogelijk onvoldoende stabiel donorhaar. Een beoordeling door een specialist is essentieel.", 'it' => "Sì. Le donne con alopecia androgenetica possono essere candidate idonee. Tuttavia, le donne con caduta diffusa dei capelli su tutto il cuoio capelluto, inclusa l'area donatrice, potrebbero non avere capelli donatori stabili a sufficienza. Una valutazione specialistica è essenziale.", 'tr' => "Evet. Androgenetik alopesisi olan kadınlar uygun aday olabilir. Ancak donör bölge dahil tüm saç derisinde yaygın saç dökülmesi yaşayan kadınlarda yeterli kararlı donör saç bulunmayabilir. Uzman değerlendirmesi şarttır."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t13'] ?? null, ['de' => "Ja. Frauen mit androgenetischer Alopezie können geeignete Kandidatinnen sein. Bei diffusem Haarausfall über die gesamte Kopfhaut, einschließlich des Spenderbereichs, reicht die stabile Spenderdichte jedoch oft nicht aus. Eine fachärztliche Beurteilung ist essenziell.", 'en' => "Yes. Women with androgenetic alopecia can be suitable candidates. However, women with diffuse hair loss across the entire scalp, including the donor area, may not have sufficient stable donor hair. A specialist assessment is essential.", 'fr' => "Oui. Les femmes atteintes d'alopécie androgénétique peuvent être de bonnes candidates. Cependant, les femmes présentant une chute de cheveux diffuse sur l'ensemble du cuir chevelu, y compris la zone donneuse, peuvent ne pas disposer d'assez de cheveux donneurs stables. Une évaluation par un spécialiste est essentielle.", 'nl' => "Ja. Vrouwen met androgenetische alopecia kunnen geschikte kandidaten zijn. Vrouwen met diffuse haaruitval over de hele hoofdhuid, inclusief het donorgebied, hebben echter mogelijk onvoldoende stabiel donorhaar. Een beoordeling door een specialist is essentieel.", 'it' => "Sì. Le donne con alopecia androgenetica possono essere candidate idonee. Tuttavia, le donne con caduta diffusa dei capelli su tutto il cuoio capelluto, inclusa l'area donatrice, potrebbero non avere capelli donatori stabili a sufficienza. Una valutazione specialistica è essenziale.", 'tr' => "Evet. Androgenetik alopesisi olan kadınlar uygun aday olabilir. Ancak donör bölge dahil tüm saç derisinde yaygın saç dökülmesi yaşayan kadınlarda yeterli kararlı donör saç bulunmayabilir. Uzman değerlendirmesi şarttır."], $currentLang) ?></p></div>
      </div>
      <div class="hp-faq-item">
        <div class="hp-faq-q" data-click="faq"><span data-ckey="faq.t14"<?= apex_cms_attrs_or($cmsHome['faq']['t14'] ?? null, ['de' => "Wie läuft die Anreise nach Istanbul ab?", 'en' => "How do I travel to Istanbul for the procedure?", 'fr' => "Comment se déroule le voyage à Istanbul pour l'intervention ?", 'nl' => "Hoe verloopt de reis naar Istanboel voor de ingreep?", 'it' => "Come funziona il viaggio a Istanbul per l'intervento?", 'tr' => "İşlem için İstanbul'a seyahat nasıl gerçekleşir?"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t14'] ?? null, ['de' => "Wie läuft die Anreise nach Istanbul ab?", 'en' => "How do I travel to Istanbul for the procedure?", 'fr' => "Comment se déroule le voyage à Istanbul pour l'intervention ?", 'nl' => "Hoe verloopt de reis naar Istanboel voor de ingreep?", 'it' => "Come funziona il viaggio a Istanbul per l'intervento?", 'tr' => "İşlem için İstanbul'a seyahat nasıl gerçekleşir?"], $currentLang) ?></span><span class="plus">+</span></div>
        <div class="hp-faq-a"><p data-ckey="faq.t15"<?= apex_cms_attrs_or($cmsHome['faq']['t15'] ?? null, ['de' => "Apex Beauty organisiert die gesamte Logistik für Patienten aus Österreich, Deutschland und der Schweiz. Der Eingriff dauert einen Tag. Die meisten Patienten fliegen am Vortag ein, ruhen sich eine Nacht aus und fliegen innerhalb von 48 Stunden zurück. Folgetermine können per Videoanruf stattfinden.", 'en' => "Apex Beauty coordinates all logistics for patients from Austria, Germany, and Switzerland. The procedure takes one day. Most patients fly in the day before, rest one night, and fly home within 48 hours. Follow-up appointments can be conducted remotely via video call.", 'fr' => "Apex Beauty coordonne toute la logistique pour les patients venant d'Autriche, d'Allemagne et de Suisse. L'intervention dure une journée. La plupart des patients arrivent la veille, se reposent une nuit et rentrent chez eux dans les 48 heures. Les rendez-vous de suivi peuvent se faire à distance par appel vidéo.", 'nl' => "Apex Beauty regelt alle logistiek voor patiënten uit Oostenrijk, Duitsland en Zwitserland. De ingreep duurt één dag. De meeste patiënten vliegen de dag ervoor in, rusten één nacht uit en vliegen binnen 48 uur terug. Vervolgafspraken kunnen op afstand via videogesprek plaatsvinden.", 'it' => "Apex Beauty coordina tutta la logistica per i pazienti provenienti da Austria, Germania e Svizzera. L'intervento dura un giorno. La maggior parte dei pazienti arriva il giorno prima, riposa una notte e rientra entro 48 ore. Gli appuntamenti di follow-up possono svolgersi da remoto tramite videochiamata.", 'tr' => "Apex Beauty, Avusturya, Almanya ve İsviçre'den gelen hastalar için tüm lojistiği koordine eder. İşlem bir gün sürer. Çoğu hasta bir gün önce uçarak gelir, bir gece dinlenir ve 48 saat içinde eve döner. Takip randevuları görüntülü görüşme yoluyla uzaktan yapılabilir."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t15'] ?? null, ['de' => "Apex Beauty organisiert die gesamte Logistik für Patienten aus Österreich, Deutschland und der Schweiz. Der Eingriff dauert einen Tag. Die meisten Patienten fliegen am Vortag ein, ruhen sich eine Nacht aus und fliegen innerhalb von 48 Stunden zurück. Folgetermine können per Videoanruf stattfinden.", 'en' => "Apex Beauty coordinates all logistics for patients from Austria, Germany, and Switzerland. The procedure takes one day. Most patients fly in the day before, rest one night, and fly home within 48 hours. Follow-up appointments can be conducted remotely via video call.", 'fr' => "Apex Beauty coordonne toute la logistique pour les patients venant d'Autriche, d'Allemagne et de Suisse. L'intervention dure une journée. La plupart des patients arrivent la veille, se reposent une nuit et rentrent chez eux dans les 48 heures. Les rendez-vous de suivi peuvent se faire à distance par appel vidéo.", 'nl' => "Apex Beauty regelt alle logistiek voor patiënten uit Oostenrijk, Duitsland en Zwitserland. De ingreep duurt één dag. De meeste patiënten vliegen de dag ervoor in, rusten één nacht uit en vliegen binnen 48 uur terug. Vervolgafspraken kunnen op afstand via videogesprek plaatsvinden.", 'it' => "Apex Beauty coordina tutta la logistica per i pazienti provenienti da Austria, Germania e Svizzera. L'intervento dura un giorno. La maggior parte dei pazienti arriva il giorno prima, riposa una notte e rientra entro 48 ore. Gli appuntamenti di follow-up possono svolgersi da remoto tramite videochiamata.", 'tr' => "Apex Beauty, Avusturya, Almanya ve İsviçre'den gelen hastalar için tüm lojistiği koordine eder. İşlem bir gün sürer. Çoğu hasta bir gün önce uçarak gelir, bir gece dinlenir ve 48 saat içinde eve döner. Takip randevuları görüntülü görüşme yoluyla uzaktan yapılabilir."], $currentLang) ?></p></div>
      </div>
      <div class="hp-faq-item">
        <div class="hp-faq-q" data-click="faq"><span data-ckey="faq.t16"<?= apex_cms_attrs_or($cmsHome['faq']['t16'] ?? null, ['de' => "Was unterscheidet Apex direkt von einem Vermittler?", 'en' => "What's the difference between Apex direct and a broker?", 'fr' => "Quelle est la différence entre Apex en direct et un intermédiaire ?", 'nl' => "Wat is het verschil tussen Apex rechtstreeks en een bemiddelaar?", 'it' => "Qual è la differenza tra Apex diretto e un intermediario?", 'tr' => "Apex direkt ile bir aracı kurum arasındaki fark nedir?"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t16'] ?? null, ['de' => "Was unterscheidet Apex direkt von einem Vermittler?", 'en' => "What's the difference between Apex direct and a broker?", 'fr' => "Quelle est la différence entre Apex en direct et un intermédiaire ?", 'nl' => "Wat is het verschil tussen Apex rechtstreeks en een bemiddelaar?", 'it' => "Qual è la differenza tra Apex diretto e un intermediario?", 'tr' => "Apex direkt ile bir aracı kurum arasındaki fark nedir?"], $currentLang) ?></span><span class="plus">+</span></div>
        <div class="hp-faq-a"><p data-ckey="faq.t17"<?= apex_cms_attrs_or($cmsHome['faq']['t17'] ?? null, ['de' => "Ein Vermittler koordiniert zwischen Patient und Klinik, ist aber medizinisch nicht involviert. Sie wissen oft nicht im Voraus, welches Team Sie behandelt. Apex Beauty ist eine Direktklinik: das Team, das Sie beraten hat, behandelt Sie auch, in unserer eigenen Einrichtung. Das bedeutet konsistente Qualität und direkte Verantwortung.", 'en' => "A broker coordinates between a patient and a clinic but isn't medically involved. You may not know in advance which team will treat you. Apex Beauty is a direct clinic: the team you consult with is the team that treats you, in our own facility. That means consistent quality and direct accountability.", 'fr' => "Un intermédiaire coordonne entre un patient et une clinique, mais n'est pas médicalement impliqué. Vous ne savez souvent pas à l'avance quelle équipe vous traitera. Apex Beauty est une clinique directe : l'équipe que vous consultez est celle qui vous traite, dans notre propre établissement. Cela garantit une qualité constante et une responsabilité directe.", 'nl' => "Een bemiddelaar coördineert tussen een patiënt en een kliniek, maar is medisch niet betrokken. U weet vaak niet vooraf welk team u zal behandelen. Apex Beauty is een directe kliniek: het team waarmee u een consult heeft, is ook het team dat u behandelt, in onze eigen faciliteit. Dat betekent consistente kwaliteit en directe verantwoordelijkheid.", 'it' => "Un intermediario coordina tra il paziente e una clinica, ma non è coinvolto dal punto di vista medico. Spesso non si sa in anticipo quale team ti curerà. Apex Beauty è una clinica diretta: il team con cui ti consulti è lo stesso che ti tratta, nella nostra struttura. Questo garantisce qualità costante e responsabilità diretta.", 'tr' => "Bir aracı, hasta ile klinik arasında koordinasyon sağlar ancak tıbbi olarak sürece dahil değildir. Sizi hangi ekibin tedavi edeceğini önceden bilemeyebilirsiniz. Apex Beauty ise direkt bir klinik: danıştığınız ekip, kendi tesisimizde sizi tedavi eden ekiptir. Bu da tutarlı kalite ve doğrudan sorumluluk anlamına gelir."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t17'] ?? null, ['de' => "Ein Vermittler koordiniert zwischen Patient und Klinik, ist aber medizinisch nicht involviert. Sie wissen oft nicht im Voraus, welches Team Sie behandelt. Apex Beauty ist eine Direktklinik: das Team, das Sie beraten hat, behandelt Sie auch, in unserer eigenen Einrichtung. Das bedeutet konsistente Qualität und direkte Verantwortung.", 'en' => "A broker coordinates between a patient and a clinic but isn't medically involved. You may not know in advance which team will treat you. Apex Beauty is a direct clinic: the team you consult with is the team that treats you, in our own facility. That means consistent quality and direct accountability.", 'fr' => "Un intermédiaire coordonne entre un patient et une clinique, mais n'est pas médicalement impliqué. Vous ne savez souvent pas à l'avance quelle équipe vous traitera. Apex Beauty est une clinique directe : l'équipe que vous consultez est celle qui vous traite, dans notre propre établissement. Cela garantit une qualité constante et une responsabilité directe.", 'nl' => "Een bemiddelaar coördineert tussen een patiënt en een kliniek, maar is medisch niet betrokken. U weet vaak niet vooraf welk team u zal behandelen. Apex Beauty is een directe kliniek: het team waarmee u een consult heeft, is ook het team dat u behandelt, in onze eigen faciliteit. Dat betekent consistente kwaliteit en directe verantwoordelijkheid.", 'it' => "Un intermediario coordina tra il paziente e una clinica, ma non è coinvolto dal punto di vista medico. Spesso non si sa in anticipo quale team ti curerà. Apex Beauty è una clinica diretta: il team con cui ti consulti è lo stesso che ti tratta, nella nostra struttura. Questo garantisce qualità costante e responsabilità diretta.", 'tr' => "Bir aracı, hasta ile klinik arasında koordinasyon sağlar ancak tıbbi olarak sürece dahil değildir. Sizi hangi ekibin tedavi edeceğini önceden bilemeyebilirsiniz. Apex Beauty ise direkt bir klinik: danıştığınız ekip, kendi tesisimizde sizi tedavi eden ekiptir. Bu da tutarlı kalite ve doğrudan sorumluluk anlamına gelir."], $currentLang) ?></p></div>
      </div>
    </div>
  </div>
</section>
...
<a class="whatsapp-fab" href="https://wa.me/436641999199" target="_blank" rel="noopener noreferrer" aria-label="Chat on WhatsApp" data-click="whatsapp">
...
<div class="consult-overlay" id="consultOverlay">
  <div class="consult-modal" role="dialog" aria-modal="true" aria-labelledby="consultTitle">
    <div class="consult-topbar">
      <button type="button" class="consult-close" data-click="close-consult" aria-label="Close">✕</button>
      <div class="consult-head">
        <div class="clogo">
          <img src="/assets/lotus-transparent.png" alt="Apex Beauty">
          <span>Apex Beauty</span>
        </div>
        <h2 id="consultTitle" data-ckey="faq.t18"<?= apex_cms_attrs_or($cmsHome['faq']['t18'] ?? null, ['de' => "Kostenlose Beratung", 'en' => "Free Consultation", 'fr' => "Consultation gratuite", 'nl' => "Gratis consult", 'it' => "Consulto gratuito", 'tr' => "Ücretsiz Danışma"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t18'] ?? null, ['de' => "Kostenlose Beratung", 'en' => "Free Consultation", 'fr' => "Consultation gratuite", 'nl' => "Gratis consult", 'it' => "Consulto gratuito", 'tr' => "Ücretsiz Danışma"], $currentLang) ?></h2>
        <p data-ckey="faq.t19"<?= apex_cms_attrs_or($cmsHome['faq']['t19'] ?? null, ['de' => "Füllen Sie das Formular aus, wir melden uns innerhalb von 24 Stunden.", 'en' => "Fill in the form and we'll get back to you within 24 hours.", 'fr' => "Remplissez le formulaire, nous vous répondrons sous 24 heures.", 'nl' => "Vul het formulier in, we nemen binnen 24 uur contact met u op.", 'it' => "Compila il modulo, ti risponderemo entro 24 ore.", 'tr' => "Formu doldurun, 24 saat içinde size dönüş yapalım."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t19'] ?? null, ['de' => "Füllen Sie das Formular aus, wir melden uns innerhalb von 24 Stunden.", 'en' => "Fill in the form and we'll get back to you within 24 hours.", 'fr' => "Remplissez le formulaire, nous vous répondrons sous 24 heures.", 'nl' => "Vul het formulier in, we nemen binnen 24 uur contact met u op.", 'it' => "Compila il modulo, ti risponderemo entro 24 ore.", 'tr' => "Formu doldurun, 24 saat içinde size dönüş yapalım."], $currentLang) ?></p>
      </div>
      <div class="consult-steps" id="consultSteps">
        <div class="cstep active" data-step="1"><span class="dot">1</span><span data-ckey="faq.t20"<?= apex_cms_attrs_or($cmsHome['faq']['t20'] ?? null, ['de' => "Info", 'en' => "Info", 'fr' => "Infos", 'nl' => "Info", 'it' => "Info", 'tr' => "Bilgi"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t20'] ?? null, ['de' => "Info", 'en' => "Info", 'fr' => "Infos", 'nl' => "Info", 'it' => "Info", 'tr' => "Bilgi"], $currentLang) ?></span></div>
        <div class="cstep-line"></div>
        <div class="cstep" data-step="2"><span class="dot">2</span><span data-ckey="faq.t21"<?= apex_cms_attrs_or($cmsHome['faq']['t21'] ?? null, ['de' => "Bedarf", 'en' => "Needs", 'fr' => "Besoins", 'nl' => "Behoefte", 'it' => "Esigenze", 'tr' => "İhtiyaçlar"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t21'] ?? null, ['de' => "Bedarf", 'en' => "Needs", 'fr' => "Besoins", 'nl' => "Behoefte", 'it' => "Esigenze", 'tr' => "İhtiyaçlar"], $currentLang) ?></span></div>
        <div class="cstep-line"></div>
        <div class="cstep" data-step="3"><span class="dot">3</span><span data-ckey="faq.t22"<?= apex_cms_attrs_or($cmsHome['faq']['t22'] ?? null, ['de' => "Fotos", 'en' => "Photos", 'fr' => "Photos", 'nl' => "Foto's", 'it' => "Foto", 'tr' => "Fotoğraflar"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t22'] ?? null, ['de' => "Fotos", 'en' => "Photos", 'fr' => "Photos", 'nl' => "Foto's", 'it' => "Foto", 'tr' => "Fotoğraflar"], $currentLang) ?></span></div>
      </div>
    </div>
    ...
    <div class="consult-pane active" id="cpane1">
      <div class="pane-title" data-ckey="faq.t23"<?= apex_cms_attrs_or($cmsHome['faq']['t23'] ?? null, ['de' => "Holen Sie sich Ihre kostenlose Haaranalyse", 'en' => "Get Your Free Hair Analysis", 'fr' => "Obtenez votre analyse capillaire gratuite", 'nl' => "Krijg uw gratis haaranalyse", 'it' => "Ottieni la tua analisi gratuita dei capelli", 'tr' => "Ücretsiz Saç Analizinizi Alın"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t23'] ?? null, ['de' => "Holen Sie sich Ihre kostenlose Haaranalyse", 'en' => "Get Your Free Hair Analysis", 'fr' => "Obtenez votre analyse capillaire gratuite", 'nl' => "Krijg uw gratis haaranalyse", 'it' => "Ottieni la tua analisi gratuita dei capelli", 'tr' => "Ücretsiz Saç Analizinizi Alın"], $currentLang) ?></div>
      <div class="pane-sub" data-ckey="faq.t24"<?= apex_cms_attrs_or($cmsHome['faq']['t24'] ?? null, ['de' => "Unser Expertenteam meldet sich innerhalb von 24 Stunden", 'en' => "Our expert team will contact you within 24 hours", 'fr' => "Notre équipe d'experts vous contactera sous 24 heures", 'nl' => "Ons expertteam neemt binnen 24 uur contact met u op", 'it' => "Il nostro team di esperti ti contatterà entro 24 ore", 'tr' => "Uzman ekibimiz 24 saat içinde sizinle iletişime geçecektir"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t24'] ?? null, ['de' => "Unser Expertenteam meldet sich innerhalb von 24 Stunden", 'en' => "Our expert team will contact you within 24 hours", 'fr' => "Notre équipe d'experts vous contactera sous 24 heures", 'nl' => "Ons expertteam neemt binnen 24 uur contact met u op", 'it' => "Il nostro team di esperti ti contatterà entro 24 ore", 'tr' => "Uzman ekibimiz 24 saat içinde sizinle iletişime geçecektir"], $currentLang) ?></div>
      <div class="cfield">
        <label data-ckey="faq.t25"<?= apex_cms_attrs_or($cmsHome['faq']['t25'] ?? null, ['de' => "Vollständiger Name *", 'en' => "Full Name *", 'fr' => "Nom complet *", 'nl' => "Volledige naam *", 'it' => "Nome completo *", 'tr' => "Ad Soyad *"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t25'] ?? null, ['de' => "Vollständiger Name *", 'en' => "Full Name *", 'fr' => "Nom complet *", 'nl' => "Volledige naam *", 'it' => "Nome completo *", 'tr' => "Ad Soyad *"], $currentLang) ?></label>
      ...
      <div class="cfield">
        <label data-ckey="faq.t26"<?= apex_cms_attrs_or($cmsHome['faq']['t26'] ?? null, ['de' => "E-Mail *", 'en' => "Email *", 'fr' => "E-mail *", 'nl' => "E-mail *", 'it' => "E-mail *", 'tr' => "E-posta *"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t26'] ?? null, ['de' => "E-Mail *", 'en' => "Email *", 'fr' => "E-mail *", 'nl' => "E-mail *", 'it' => "E-mail *", 'tr' => "E-posta *"], $currentLang) ?></label>
        <input type="email" id="cfEmail" placeholder="email@example.com" data-input="validate1">
      </div>
      <div class="cfield">
        <label data-ckey="faq.t27"<?= apex_cms_attrs_or($cmsHome['faq']['t27'] ?? null, ['de' => "Land *", 'en' => "Country *", 'fr' => "Pays *", 'nl' => "Land *", 'it' => "Paese *", 'tr' => "Ülke *"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t27'] ?? null, ['de' => "Land *", 'en' => "Country *", 'fr' => "Pays *", 'nl' => "Land *", 'it' => "Paese *", 'tr' => "Ülke *"], $currentLang) ?></label>
      ...
      <div class="cfield">
        <label data-ckey="faq.t28"<?= apex_cms_attrs_or($cmsHome['faq']['t28'] ?? null, ['de' => "Telefon *", 'en' => "Phone *", 'fr' => "Téléphone *", 'nl' => "Telefoon *", 'it' => "Telefono *", 'tr' => "Telefon *"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t28'] ?? null, ['de' => "Telefon *", 'en' => "Phone *", 'fr' => "Téléphone *", 'nl' => "Telefoon *", 'it' => "Telefono *", 'tr' => "Telefon *"], $currentLang) ?></label>
        <div class="phone-row">
    ...
    <div class="consult-pane" id="cpane2">
      <div class="cfield">
        <label data-ckey="faq.t30"<?= apex_cms_attrs_or($cmsHome['faq']['t30'] ?? null, ['de' => "Ihr Geschlecht *", 'en' => "Your Gender *", 'fr' => "Votre sexe *", 'nl' => "Uw geslacht *", 'it' => "Il tuo genere *", 'tr' => "Cinsiyetiniz *"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t30'] ?? null, ['de' => "Ihr Geschlecht *", 'en' => "Your Gender *", 'fr' => "Votre sexe *", 'nl' => "Uw geslacht *", 'it' => "Il tuo genere *", 'tr' => "Cinsiyetiniz *"], $currentLang) ?></label>
        <div class="opt-grid cols-2" id="genderRow">
          <div class="opt-card radio centered" data-value="male" data-click="pick" data-row="genderRow">
            <span data-ckey="faq.t31"<?= apex_cms_attrs_or($cmsHome['faq']['t31'] ?? null, ['de' => "Männlich", 'en' => "Male", 'fr' => "Homme", 'nl' => "Man", 'it' => "Uomo", 'tr' => "Erkek"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t31'] ?? null, ['de' => "Männlich", 'en' => "Male", 'fr' => "Homme", 'nl' => "Man", 'it' => "Uomo", 'tr' => "Erkek"], $currentLang) ?></span>
          </div>
          <div class="opt-card radio centered" data-value="female" data-click="pick" data-row="genderRow">
            <span data-ckey="faq.t32"<?= apex_cms_attrs_or($cmsHome['faq']['t32'] ?? null, ['de' => "Weiblich", 'en' => "Female", 'fr' => "Femme", 'nl' => "Vrouw", 'it' => "Donna", 'tr' => "Kadın"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t32'] ?? null, ['de' => "Weiblich", 'en' => "Female", 'fr' => "Femme", 'nl' => "Vrouw", 'it' => "Donna", 'tr' => "Kadın"], $currentLang) ?></span>
          </div>
        </div>
      </div>
      <div class="cfield">
        <label data-ckey="faq.t33"<?= apex_cms_attrs_or($cmsHome['faq']['t33'] ?? null, ['de' => "Verfahren, die Sie interessieren *", 'en' => "Procedures You're Interested In *", 'fr' => "Interventions qui vous intéressent *", 'nl' => "Ingrepen waarin u geïnteresseerd bent *", 'it' => "Procedure di tuo interesse *", 'tr' => "İlgilendiğiniz İşlemler *"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t33'] ?? null, ['de' => "Verfahren, die Sie interessieren *", 'en' => "Procedures You're Interested In *", 'fr' => "Interventions qui vous intéressent *", 'nl' => "Ingrepen waarin u geïnteresseerd bent *", 'it' => "Procedure di tuo interesse *", 'tr' => "İlgilendiğiniz İşlemler *"], $currentLang) ?></label>
        <div class="opt-grid cols-1" id="procRow">
          <div class="opt-card" data-value="hair" data-click="chip">
            <span class="mark"></span><span data-ckey="faq.t34"<?= apex_cms_attrs_or($cmsHome['faq']['t34'] ?? null, ['de' => "Haartransplantation", 'en' => "Hair Transplant", 'fr' => "Greffe de cheveux", 'nl' => "Haartransplantatie", 'it' => "Trapianto di capelli", 'tr' => "Saç Ekimi"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t34'] ?? null, ['de' => "Haartransplantation", 'en' => "Hair Transplant", 'fr' => "Greffe de cheveux", 'nl' => "Haartransplantatie", 'it' => "Trapianto di capelli", 'tr' => "Saç Ekimi"], $currentLang) ?></span>
          </div>
          <div class="opt-card" data-value="beard" data-click="chip">
            <span class="mark"></span><span data-ckey="faq.t35"<?= apex_cms_attrs_or($cmsHome['faq']['t35'] ?? null, ['de' => "Barttransplantation", 'en' => "Beard Transplant", 'fr' => "Greffe de barbe", 'nl' => "Baardtransplantatie", 'it' => "Trapianto di barba", 'tr' => "Sakal Ekimi"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t35'] ?? null, ['de' => "Barttransplantation", 'en' => "Beard Transplant", 'fr' => "Greffe de barbe", 'nl' => "Baardtransplantatie", 'it' => "Trapianto di barba", 'tr' => "Sakal Ekimi"], $currentLang) ?></span>
          </div>
          <div class="opt-card" data-value="eyebrow" data-click="chip">
            <span class="mark"></span><span data-ckey="faq.t36"<?= apex_cms_attrs_or($cmsHome['faq']['t36'] ?? null, ['de' => "Augenbrauentransplantation", 'en' => "Eyebrow Transplant", 'fr' => "Greffe de sourcils", 'nl' => "Wenkbrauwtransplantatie", 'it' => "Trapianto di sopracciglia", 'tr' => "Kaş Ekimi"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t36'] ?? null, ['de' => "Augenbrauentransplantation", 'en' => "Eyebrow Transplant", 'fr' => "Greffe de sourcils", 'nl' => "Wenkbrauwtransplantatie", 'it' => "Trapianto di sopracciglia", 'tr' => "Kaş Ekimi"], $currentLang) ?></span>
          </div>
        </div>
        <div class="cgroup-note" data-ckey="faq.t37"<?= apex_cms_attrs_or($cmsHome['faq']['t37'] ?? null, ['de' => "Unterstützende Therapien", 'en' => "Supporting Therapies", 'fr' => "Thérapies complémentaires", 'nl' => "Ondersteunende therapieën", 'it' => "Terapie di supporto", 'tr' => "Destekleyici Tedaviler"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t37'] ?? null, ['de' => "Unterstützende Therapien", 'en' => "Supporting Therapies", 'fr' => "Thérapies complémentaires", 'nl' => "Ondersteunende therapieën", 'it' => "Terapie di supporto", 'tr' => "Destekleyici Tedaviler"], $currentLang) ?></div>
        <div class="opt-grid cols-2" id="therapyRow">
          <div class="opt-card" data-value="prp" data-click="chip">
            <span class="mark"></span><span data-ckey="faq.t38"<?= apex_cms_attrs_or($cmsHome['faq']['t38'] ?? null, ['de' => "PRP-Therapie", 'en' => "PRP Therapy", 'fr' => "Thérapie PRP", 'nl' => "PRP-therapie", 'it' => "Terapia PRP", 'tr' => "PRP Tedavisi"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t38'] ?? null, ['de' => "PRP-Therapie", 'en' => "PRP Therapy", 'fr' => "Thérapie PRP", 'nl' => "PRP-therapie", 'it' => "Terapia PRP", 'tr' => "PRP Tedavisi"], $currentLang) ?></span>
          </div>
          <div class="opt-card" data-value="stemcell" data-click="chip">
            <span class="mark"></span><span data-ckey="faq.t39"<?= apex_cms_attrs_or($cmsHome['faq']['t39'] ?? null, ['de' => "Stammzelltherapie", 'en' => "Stem Cell Therapy", 'fr' => "Thérapie par cellules souches", 'nl' => "Stamceltherapie", 'it' => "Terapia con cellule staminali", 'tr' => "Kök Hücre Tedavisi"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t39'] ?? null, ['de' => "Stammzelltherapie", 'en' => "Stem Cell Therapy", 'fr' => "Thérapie par cellules souches", 'nl' => "Stamceltherapie", 'it' => "Terapia con cellule staminali", 'tr' => "Kök Hücre Tedavisi"], $currentLang) ?></span>
          </div>
          <div class="opt-card" data-value="exosome" data-click="chip">
            <span class="mark"></span><span data-ckey="faq.t40"<?= apex_cms_attrs_or($cmsHome['faq']['t40'] ?? null, ['de' => "Exosom-Therapie", 'en' => "Exosome Therapy", 'fr' => "Thérapie par exosomes", 'nl' => "Exosoomtherapie", 'it' => "Terapia con esosomi", 'tr' => "Ekzozom Tedavisi"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t40'] ?? null, ['de' => "Exosom-Therapie", 'en' => "Exosome Therapy", 'fr' => "Thérapie par exosomes", 'nl' => "Exosoomtherapie", 'it' => "Terapia con esosomi", 'tr' => "Ekzozom Tedavisi"], $currentLang) ?></span>
          </div>
          <div class="opt-card" data-value="hbot" data-click="chip">
            <span class="mark"></span><span data-ckey="faq.t41"<?= apex_cms_attrs_or($cmsHome['faq']['t41'] ?? null, ['de' => "Hyperbarer Sauerstoff", 'en' => "Hyperbaric Oxygen", 'fr' => "Oxygénothérapie hyperbare", 'nl' => "Hyperbare zuurstoftherapie", 'it' => "Ossigenoterapia iperbarica", 'tr' => "Hiperbarik Oksijen"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t41'] ?? null, ['de' => "Hyperbarer Sauerstoff", 'en' => "Hyperbaric Oxygen", 'fr' => "Oxygénothérapie hyperbare", 'nl' => "Hyperbare zuurstoftherapie", 'it' => "Ossigenoterapia iperbarica", 'tr' => "Hiperbarik Oksijen"], $currentLang) ?></span>
          </div>
        </div>
      </div>
      <div class="cfield">
        <label data-ckey="faq.t42"<?= apex_cms_attrs_or($cmsHome['faq']['t42'] ?? null, ['de' => "Wann planen Sie den Eingriff?", 'en' => "When Are You Planning the Procedure?", 'fr' => "Quand prévoyez-vous l'intervention ?", 'nl' => "Wanneer plant u de ingreep?", 'it' => "Quando prevedi l'intervento?", 'tr' => "İşlemi Ne Zaman Planlıyorsunuz?"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t42'] ?? null, ['de' => "Wann planen Sie den Eingriff?", 'en' => "When Are You Planning the Procedure?", 'fr' => "Quand prévoyez-vous l'intervention ?", 'nl' => "Wanneer plant u de ingreep?", 'it' => "Quando prevedi l'intervento?", 'tr' => "İşlemi Ne Zaman Planlıyorsunuz?"], $currentLang) ?></label>
        <div class="opt-grid cols-3" id="timingRow">
          <div class="opt-card radio centered" data-value="this-month" data-click="pick" data-row="timingRow"><span data-ckey="faq.t43"<?= apex_cms_attrs_or($cmsHome['faq']['t43'] ?? null, ['de' => "Diesen Monat", 'en' => "This month", 'fr' => "Ce mois-ci", 'nl' => "Deze maand", 'it' => "Questo mese", 'tr' => "Bu Ay"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t43'] ?? null, ['de' => "Diesen Monat", 'en' => "This month", 'fr' => "Ce mois-ci", 'nl' => "Deze maand", 'it' => "Questo mese", 'tr' => "Bu Ay"], $currentLang) ?></span></div>
          <div class="opt-card radio centered" data-value="1-3" data-click="pick" data-row="timingRow"><span data-ckey="faq.t44"<?= apex_cms_attrs_or($cmsHome['faq']['t44'] ?? null, ['de' => "In 1–3 Monaten", 'en' => "In 1–3 months", 'fr' => "Dans 1 à 3 mois", 'nl' => "Over 1–3 maanden", 'it' => "Tra 1 e 3 mesi", 'tr' => "1-3 Ay İçinde"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t44'] ?? null, ['de' => "In 1–3 Monaten", 'en' => "In 1–3 months", 'fr' => "Dans 1 à 3 mois", 'nl' => "Over 1–3 maanden", 'it' => "Tra 1 e 3 mesi", 'tr' => "1-3 Ay İçinde"], $currentLang) ?></span></div>
          <div class="opt-card radio centered" data-value="3-6" data-click="pick" data-row="timingRow"><span data-ckey="faq.t45"<?= apex_cms_attrs_or($cmsHome['faq']['t45'] ?? null, ['de' => "In 3–6 Monaten", 'en' => "In 3–6 months", 'fr' => "Dans 3 à 6 mois", 'nl' => "Over 3–6 maanden", 'it' => "Tra 3 e 6 mesi", 'tr' => "3-6 Ay İçinde"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t45'] ?? null, ['de' => "In 3–6 Monaten", 'en' => "In 3–6 months", 'fr' => "Dans 3 à 6 mois", 'nl' => "Over 3–6 maanden", 'it' => "Tra 3 e 6 mesi", 'tr' => "3-6 Ay İçinde"], $currentLang) ?></span></div>
          <div class="opt-card radio centered" data-value="6plus" data-click="pick" data-row="timingRow"><span data-ckey="faq.t46"<?= apex_cms_attrs_or($cmsHome['faq']['t46'] ?? null, ['de' => "In 6+ Monaten", 'en' => "In 6+ months", 'fr' => "Dans 6+ mois", 'nl' => "Over 6+ maanden", 'it' => "Tra 6+ mesi", 'tr' => "6+ Ay İçinde"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t46'] ?? null, ['de' => "In 6+ Monaten", 'en' => "In 6+ months", 'fr' => "Dans 6+ mois", 'nl' => "Over 6+ maanden", 'it' => "Tra 6+ mesi", 'tr' => "6+ Ay İçinde"], $currentLang) ?></span></div>
          <div class="opt-card radio centered u-02" data-value="research" data-click="pick" data-row="timingRow"><span data-ckey="faq.t47"<?= apex_cms_attrs_or($cmsHome['faq']['t47'] ?? null, ['de' => "Nur recherchieren", 'en' => "Just researching", 'fr' => "Je me renseigne seulement", 'nl' => "Alleen aan het oriënteren", 'it' => "Sto solo informandomi", 'tr' => "Sadece Araştırıyorum"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t47'] ?? null, ['de' => "Nur recherchieren", 'en' => "Just researching", 'fr' => "Je me renseigne seulement", 'nl' => "Alleen aan het oriënteren", 'it' => "Sto solo informandomi", 'tr' => "Sadece Araştırıyorum"], $currentLang) ?></span></div>
        </div>
      </div>
      <div class="cfield">
        <label data-ckey="faq.t48"<?= apex_cms_attrs_or($cmsHome['faq']['t48'] ?? null, ['de' => "Zusätzliche Notizen (optional)", 'en' => "Additional Notes (Optional)", 'fr' => "Remarques supplémentaires (facultatif)", 'nl' => "Aanvullende opmerkingen (optioneel)", 'it' => "Note aggiuntive (facoltativo)", 'tr' => "Ek Notlar (İsteğe Bağlı)"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t48'] ?? null, ['de' => "Zusätzliche Notizen (optional)", 'en' => "Additional Notes (Optional)", 'fr' => "Remarques supplémentaires (facultatif)", 'nl' => "Aanvullende opmerkingen (optioneel)", 'it' => "Note aggiuntive (facoltativo)", 'tr' => "Ek Notlar (İsteğe Bağlı)"], $currentLang) ?></label>
      ...
      <div class="consult-nav">
        <button type="button" class="cback" data-click="step" data-step="1" data-ckey="faq.t49"<?= apex_cms_attrs_or($cmsHome['faq']['t49'] ?? null, ['de' => "Zurück", 'en' => "Back", 'fr' => "Retour", 'nl' => "Terug", 'it' => "Indietro", 'tr' => "Geri"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t49'] ?? null, ['de' => "Zurück", 'en' => "Back", 'fr' => "Retour", 'nl' => "Terug", 'it' => "Indietro", 'tr' => "Geri"], $currentLang) ?></button>
        <button type="button" class="cnext" id="cnext2" disabled data-click="step" data-step="3" data-ckey="faq.t50"<?= apex_cms_attrs_or($cmsHome['faq']['t50'] ?? null, ['de' => "Weiter", 'en' => "Continue", 'fr' => "Continuer", 'nl' => "Doorgaan", 'it' => "Continua", 'tr' => "Devam Et"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t50'] ?? null, ['de' => "Weiter", 'en' => "Continue", 'fr' => "Continuer", 'nl' => "Doorgaan", 'it' => "Continua", 'tr' => "Devam Et"], $currentLang) ?></button>
      </div>
    </div>

    <!-- STEP 3: Photos -->
    <div class="consult-pane" id="cpane3">
      <div class="photo-note" data-ckey="faq.t51"<?= apex_cms_attrs_or($cmsHome['faq']['t51'] ?? null, ['de' => "📸 Fotos sind optional. Unsere Experten kontaktieren Sie in jedem Fall.", 'en' => "📸 Photos are optional. Our experts will contact you either way.", 'fr' => "📸 Les photos sont facultatives. Nos experts vous contacteront dans tous les cas.", 'nl' => "📸 Foto's zijn optioneel. Onze experts nemen sowieso contact met u op.", 'it' => "📸 Le foto sono facoltative. I nostri esperti ti contatteranno comunque.", 'tr' => "📸 Fotoğraflar isteğe bağlıdır. Uzmanlarımız her durumda sizinle iletişime geçecektir."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t51'] ?? null, ['de' => "📸 Fotos sind optional. Unsere Experten kontaktieren Sie in jedem Fall.", 'en' => "📸 Photos are optional. Our experts will contact you either way.", 'fr' => "📸 Les photos sont facultatives. Nos experts vous contacteront dans tous les cas.", 'nl' => "📸 Foto's zijn optioneel. Onze experts nemen sowieso contact met u op.", 'it' => "📸 Le foto sono facoltative. I nostri esperti ti contatteranno comunque.", 'tr' => "📸 Fotoğraflar isteğe bağlıdır. Uzmanlarımız her durumda sizinle iletişime geçecektir."], $currentLang) ?></div>
      <div class="photo-grid">
        <div class="photo-slot" id="slot-front">
          ...
          <b data-ckey="faq.t52"<?= apex_cms_attrs_or($cmsHome['faq']['t52'] ?? null, ['de' => "Vorne", 'en' => "Front", 'fr' => "Face avant", 'nl' => "Voorkant", 'it' => "Fronte", 'tr' => "Ön"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t52'] ?? null, ['de' => "Vorne", 'en' => "Front", 'fr' => "Face avant", 'nl' => "Voorkant", 'it' => "Fronte", 'tr' => "Ön"], $currentLang) ?></b>
          <span data-ckey="faq.t53"<?= apex_cms_attrs_or($cmsHome['faq']['t53'] ?? null, ['de' => "Gesicht sichtbar", 'en' => "Face visible", 'fr' => "Visage visible", 'nl' => "Gezicht zichtbaar", 'it' => "Volto visibile", 'tr' => "Yüz Görünür"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t53'] ?? null, ['de' => "Gesicht sichtbar", 'en' => "Face visible", 'fr' => "Visage visible", 'nl' => "Gezicht zichtbaar", 'it' => "Volto visibile", 'tr' => "Yüz Görünür"], $currentLang) ?></span>
        ...
        <div class="photo-slot" id="slot-top">
          ...
          <b data-ckey="faq.t54"<?= apex_cms_attrs_or($cmsHome['faq']['t54'] ?? null, ['de' => "Oben", 'en' => "Top", 'fr' => "Dessus", 'nl' => "Bovenkant", 'it' => "Sopra", 'tr' => "Üst"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t54'] ?? null, ['de' => "Oben", 'en' => "Top", 'fr' => "Dessus", 'nl' => "Bovenkant", 'it' => "Sopra", 'tr' => "Üst"], $currentLang) ?></b>
          <span data-ckey="faq.t55"<?= apex_cms_attrs_or($cmsHome['faq']['t55'] ?? null, ['de' => "Von oben", 'en' => "From above", 'fr' => "Vue de dessus", 'nl' => "Van bovenaf", 'it' => "Dall'alto", 'tr' => "Yukarıdan"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t55'] ?? null, ['de' => "Von oben", 'en' => "From above", 'fr' => "Vue de dessus", 'nl' => "Van bovenaf", 'it' => "Dall'alto", 'tr' => "Yukarıdan"], $currentLang) ?></span>
        ...
        <div class="photo-slot" id="slot-side">
          ...
          <b data-ckey="faq.t56"<?= apex_cms_attrs_or($cmsHome['faq']['t56'] ?? null, ['de' => "Seite", 'en' => "Side", 'fr' => "Profil", 'nl' => "Zijkant", 'it' => "Lato", 'tr' => "Yan"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t56'] ?? null, ['de' => "Seite", 'en' => "Side", 'fr' => "Profil", 'nl' => "Zijkant", 'it' => "Lato", 'tr' => "Yan"], $currentLang) ?></b>
          <span data-ckey="faq.t57"<?= apex_cms_attrs_or($cmsHome['faq']['t57'] ?? null, ['de' => "Profil", 'en' => "Profile", 'fr' => "Profil", 'nl' => "Profiel", 'it' => "Profilo", 'tr' => "Profil"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t57'] ?? null, ['de' => "Profil", 'en' => "Profile", 'fr' => "Profil", 'nl' => "Profiel", 'it' => "Profilo", 'tr' => "Profil"], $currentLang) ?></span>
        ...
        <div class="photo-slot" id="slot-donor">
          ...
          <b data-ckey="faq.t58"<?= apex_cms_attrs_or($cmsHome['faq']['t58'] ?? null, ['de' => "Spender", 'en' => "Donor", 'fr' => "Donneuse", 'nl' => "Donor", 'it' => "Donatrice", 'tr' => "Donör"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t58'] ?? null, ['de' => "Spender", 'en' => "Donor", 'fr' => "Donneuse", 'nl' => "Donor", 'it' => "Donatrice", 'tr' => "Donör"], $currentLang) ?></b>
          <span data-ckey="faq.t59"<?= apex_cms_attrs_or($cmsHome['faq']['t59'] ?? null, ['de' => "Hinterkopf", 'en' => "Back of head", 'fr' => "Arrière de la tête", 'nl' => "Achterhoofd", 'it' => "Retro della testa", 'tr' => "Baş Arkası"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t59'] ?? null, ['de' => "Hinterkopf", 'en' => "Back of head", 'fr' => "Arrière de la tête", 'nl' => "Achterhoofd", 'it' => "Retro della testa", 'tr' => "Baş Arkası"], $currentLang) ?></span>
          <input type="file" accept="image/*" data-change="slot" data-slot="slot-donor">
        </div>
      </div>
      <div class="photo-note"><span id="photoCount">0</span>/4 <span data-ckey="faq.t60"<?= apex_cms_attrs_or($cmsHome['faq']['t60'] ?? null, ['de' => "Fotos hochgeladen", 'en' => "photos uploaded", 'fr' => "photos téléchargées", 'nl' => "foto's geüpload", 'it' => "foto caricate", 'tr' => "fotoğraf yüklendi"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t60'] ?? null, ['de' => "Fotos hochgeladen", 'en' => "photos uploaded", 'fr' => "photos téléchargées", 'nl' => "foto's geüpload", 'it' => "foto caricate", 'tr' => "fotoğraf yüklendi"], $currentLang) ?></span></div>
      <div class="cfield">
        <label data-ckey="faq.t61"<?= apex_cms_attrs_or($cmsHome['faq']['t61'] ?? null, ['de' => "Rabattgutschein (optional)", 'en' => "Discount Coupon (Optional)", 'fr' => "Code de réduction (facultatif)", 'nl' => "Kortingscode (optioneel)", 'it' => "Codice sconto (facoltativo)", 'tr' => "İndirim Kuponu (İsteğe Bağlı)"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t61'] ?? null, ['de' => "Rabattgutschein (optional)", 'en' => "Discount Coupon (Optional)", 'fr' => "Code de réduction (facultatif)", 'nl' => "Kortingscode (optioneel)", 'it' => "Codice sconto (facoltativo)", 'tr' => "İndirim Kuponu (İsteğe Bağlı)"], $currentLang) ?></label>
      ...
      <div class="check-row">
        ...
        <span data-ckey="faq.t62"<?= apex_cms_attrs_or($cmsHome['faq']['t62'] ?? null, ['de' => "Ich möchte über Aktionen und Angebote informiert werden.", 'en' => "I'd like to be informed about promotions and offers.", 'fr' => "Je souhaite être informé(e) des promotions et offres.", 'nl' => "Ik wil op de hoogte worden gehouden van acties en aanbiedingen.", 'it' => "Desidero essere informato/a su promozioni e offerte.", 'tr' => "Kampanyalar ve fırsatlar hakkında bilgilendirilmek istiyorum."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t62'] ?? null, ['de' => "Ich möchte über Aktionen und Angebote informiert werden.", 'en' => "I'd like to be informed about promotions and offers.", 'fr' => "Je souhaite être informé(e) des promotions et offres.", 'nl' => "Ik wil op de hoogte worden gehouden van acties en aanbiedingen.", 'it' => "Desidero essere informato/a su promozioni e offerte.", 'tr' => "Kampanyalar ve fırsatlar hakkında bilgilendirilmek istiyorum."], $currentLang) ?></span>
      </div>
      <div class="gdpr-badge" data-ckey="faq.t63"<?= apex_cms_attrs_or($cmsHome['faq']['t63'] ?? null, ['de' => "🇪🇺 DSGVO · Ihre Daten sind geschützt", 'en' => "🇪🇺 GDPR · Your data is protected", 'fr' => "🇪🇺 RGPD · Vos données sont protégées", 'nl' => "🇪🇺 AVG · Uw gegevens zijn beschermd", 'it' => "🇪🇺 GDPR · I tuoi dati sono protetti", 'tr' => "🇪🇺 GDPR · Verileriniz Korunmaktadır"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t63'] ?? null, ['de' => "🇪🇺 DSGVO · Ihre Daten sind geschützt", 'en' => "🇪🇺 GDPR · Your data is protected", 'fr' => "🇪🇺 RGPD · Vos données sont protégées", 'nl' => "🇪🇺 AVG · Uw gegevens zijn beschermd", 'it' => "🇪🇺 GDPR · I tuoi dati sono protetti", 'tr' => "🇪🇺 GDPR · Verileriniz Korunmaktadır"], $currentLang) ?></div>
      <div class="consult-nav">
        <button type="button" class="cback" data-click="step" data-step="2" data-ckey="faq.t64"<?= apex_cms_attrs_or($cmsHome['faq']['t64'] ?? null, ['de' => "Zurück", 'en' => "Back", 'fr' => "Retour", 'nl' => "Terug", 'it' => "Indietro", 'tr' => "Geri"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t64'] ?? null, ['de' => "Zurück", 'en' => "Back", 'fr' => "Retour", 'nl' => "Terug", 'it' => "Indietro", 'tr' => "Geri"], $currentLang) ?></button>
        <button type="button" class="cnext" id="cnext3" disabled data-click="submit-consult" data-ckey="faq.t65"<?= apex_cms_attrs_or($cmsHome['faq']['t65'] ?? null, ['de' => "Absenden", 'en' => "Submit", 'fr' => "Envoyer", 'nl' => "Versturen", 'it' => "Invia", 'tr' => "Gönder"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t65'] ?? null, ['de' => "Absenden", 'en' => "Submit", 'fr' => "Envoyer", 'nl' => "Versturen", 'it' => "Invia", 'tr' => "Gönder"], $currentLang) ?></button>
      </div>
    </div>
    ...
    <div class="consult-pane" id="cpaneSuccess">
      <div class="consult-success">
        ...
        <h3 data-ckey="faq.t66"<?= apex_cms_attrs_or($cmsHome['faq']['t66'] ?? null, ['de' => "Vielen Dank!", 'en' => "Thank You!", 'fr' => "Merci !", 'nl' => "Bedankt!", 'it' => "Grazie!", 'tr' => "Teşekkürler!"]) ?>><?= apex_cms_value_or($cmsHome['faq']['t66'] ?? null, ['de' => "Vielen Dank!", 'en' => "Thank You!", 'fr' => "Merci !", 'nl' => "Bedankt!", 'it' => "Grazie!", 'tr' => "Teşekkürler!"], $currentLang) ?></h3>
        <p data-ckey="faq.t67"<?= apex_cms_attrs_or($cmsHome['faq']['t67'] ?? null, ['de' => "Ihre Anfrage ist bei uns eingegangen. Unser Team meldet sich innerhalb von 24 Stunden bei Ihnen.", 'en' => "We've received your request. Our team will get back to you within 24 hours.", 'fr' => "Nous avons bien reçu votre demande. Notre équipe vous recontactera sous 24 heures.", 'nl' => "We hebben uw aanvraag ontvangen. Ons team neemt binnen 24 uur contact met u op.", 'it' => "Abbiamo ricevuto la tua richiesta. Il nostro team ti risponderà entro 24 ore.", 'tr' => "Talebinizi aldık. Ekibimiz 24 saat içinde sizinle iletişime geçecektir."]) ?>><?= apex_cms_value_or($cmsHome['faq']['t67'] ?? null, ['de' => "Ihre Anfrage ist bei uns eingegangen. Unser Team meldet sich innerhalb von 24 Stunden bei Ihnen.", 'en' => "We've received your request. Our team will get back to you within 24 hours.", 'fr' => "Nous avons bien reçu votre demande. Notre équipe vous recontactera sous 24 heures.", 'nl' => "We hebben uw aanvraag ontvangen. Ons team neemt binnen 24 uur contact met u op.", 'it' => "Abbiamo ricevuto la tua richiesta. Il nostro team ti risponderà entro 24 ore.", 'tr' => "Talebinizi aldık. Ekibimiz 24 saat içinde sizinle iletişime geçecektir."], $currentLang) ?></p>
      </div>
    </div>
    </div>
  </div>
