...
function apex_ai_lead_copy(string $key, string $textLang, array $vars = []): string
{
    $en = [
        ...
        'confirm' => "Here's what I have:\nName: {name}\nEmail: {email}\nPhone: {phone}\nTiming: {timing}\n\nMay I send this to " . APEX_BUSINESS_NAME . "? Your details are used only to answer this enquiry, are not passed to anyone else, and you can ask us to delete them at any time. Full details: " . APEX_SITE_URL . "/en/privacy",
    ...
    $de = [
        ...
        'confirm' => "Das habe ich notiert:\nName: {name}\nE-Mail: {email}\nTelefon: {phone}\nZeitpunkt: {timing}\n\nDarf ich das an " . APEX_BUSINESS_NAME . " senden? Ihre Angaben werden ausschließlich zur Beantwortung dieser Anfrage verwendet, nicht an Dritte weitergegeben, und Sie können jederzeit deren Löschung verlangen. Mehr dazu: " . APEX_SITE_URL . "/privacy",
