...
<section class="hp-hero">
  ...
  <div class="hp-hero-inner">
    <div class="eyebrow"><span class="dot"></span><span data-de="Verfahren" data-en="Procedure" data-fr="Procédure" data-nl="Procedure" data-it="Procedura" data-tr="İşlem">Verfahren</span></div>
    <h1 data-ckey="hero.heading" data-de="&lt;span&gt;Haartransplantation&lt;/span&gt; bei Apex Beauty" data-en="Hair Transplantation &lt;span&gt;at Apex Beauty&lt;/span&gt;" data-fr="Greffe de cheveux &lt;span&gt;chez Apex Beauty&lt;/span&gt;" data-nl="Haartransplantatie &lt;span&gt;bij Apex Beauty&lt;/span&gt;" data-it="Trapianto di capelli &lt;span&gt;presso Apex Beauty&lt;/span&gt;" data-tr="Saç Ekimi &lt;span&gt;Apex Beauty'de&lt;/span&gt;">Haartransplantation bei Apex Beauty</h1>
    <p data-ckey="hero.sub" data-de="Ein chirurgischer Eingriff unter örtlicher Betäubung. Gesunde, DHT-resistente Follikel werden aus dem Spenderbereich entnommen und in ausgedünnte Areale verpflanzt, wo sie dauerhaft weiterwachsen." data-en="A surgical procedure under local anaesthesia. Healthy, DHT-resistant follicles are taken from the donor area and relocated to thinning areas, where they keep growing for life." data-fr="Une intervention chirurgicale sous anesthésie locale. Des follicules sains, résistants à la DHT, sont prélevés dans la zone donneuse et replantés dans les zones clairsemées, où ils continuent de pousser à vie." data-nl="Een chirurgische ingreep onder lokale verdoving. Gezonde, DHT-resistente follikels worden uit het donorgebied gehaald en verplaatst naar dunner wordende zones, waar ze levenslang blijven doorgroeien." data-it="Una procedura chirurgica in anestesia locale. Follicoli sani e resistenti al DHT vengono prelevati dall'area donatrice e trapiantati nelle zone diradate, dove continuano a crescere per tutta la vita." data-tr="Lokal anestezi altında yapılan cerrahi bir işlemdir. Sağlıklı, DHT'ye dirençli foliküller donör bölgeden alınarak seyrelen bölgelere nakledilir ve orada ömür boyu büyümeye devam eder.">Ein chirurgischer Eingriff unter örtlicher Betäubung. Gesunde, DHT-resistente Follikel werden aus dem Spenderbereich entnommen und in ausgedünnte Areale verpflanzt, wo sie dauerhaft weiterwachsen.</p>
  </div>
</section>

<div class="hp-quicknav-wrap">
  <div class="hp-quicknav" id="hpQuicknav">
    <a href="#umfasst"><span data-de="Was es umfasst" data-en="What it involves" data-fr="En quoi elle consiste" data-nl="Wat het inhoudt" data-it="Cosa comprende" data-tr="Neleri Kapsar">Was es umfasst</span></a>
    <a href="#geeignet"><span data-de="Wer ist geeignet" data-en="Candidacy" data-fr="Éligibilité" data-nl="Geschiktheid" data-it="Idoneità" data-tr="Adaylık">Wer ist geeignet</span></a>
    <a href="#genesung-service"><span data-de="Genesung" data-en="Recovery" data-fr="Récupération" data-nl="Herstel" data-it="Recupero" data-tr="İyileşme">Genesung</span></a>
    <a href="#ergebnisse"><span data-de="Ergebnisse" data-en="Results" data-fr="Résultats" data-nl="Resultaten" data-it="Risultati" data-tr="Sonuçlar">Ergebnisse</span></a>
  </div>
</div>
...
<section class="hp-section" id="umfasst">
  <div class="hp-section-head">
    ...
    <div>
      <h2 data-ckey="umfasst.heading" data-de="Was die Behandlung umfasst" data-en="What the treatment involves" data-fr="En quoi consiste le traitement" data-nl="Wat de behandeling inhoudt" data-it="Cosa comprende il trattamento" data-tr="Tedavi Neleri Kapsar">Was die Behandlung umfasst</h2>
      <p data-ckey="umfasst.body" data-de="Apex Beauty führt drei anerkannte Transplantationstechniken durch, je nach Fläche, Graft-Anzahl und gewünschtem Detailgrad." data-en="Apex Beauty performs three recognised transplantation techniques, chosen based on area, graft count, and desired level of detail." data-fr="Apex Beauty pratique trois techniques de greffe reconnues, choisies selon la zone, le nombre de greffons et le niveau de précision souhaité." data-nl="Apex Beauty past drie erkende transplantatietechnieken toe, gekozen op basis van het gebied, het aantal grafts en het gewenste detailniveau." data-it="Apex Beauty esegue tre tecniche di trapianto riconosciute, scelte in base all'area, al numero di innesti e al livello di dettaglio desiderato." data-tr="Apex Beauty, bölgeye, greft sayısına ve istenen detay düzeyine göre seçilen üç kabul görmüş nakil tekniği uygular.">Apex Beauty führt drei anerkannte Transplantationstechniken durch, je nach Fläche, Graft-Anzahl und gewünschtem Detailgrad.</p>
    </div>
  </div>
...
<section class="hp-section alt" id="geeignet">
  ...
  <div class="hp-section-head">
    ...
    <div>
      <h2 data-ckey="geeignet.heading" data-de="Wer ist geeignet?" data-en="Who is a suitable candidate?" data-fr="Qui est un bon candidat ?" data-nl="Wie komt in aanmerking?" data-it="Chi è un candidato idoneo?" data-tr="Kimler Uygun Adaydır?">Wer ist geeignet?</h2>
      <p data-ckey="geeignet.body" data-de="Eine kostenlose Beratung mit Haaranalyse gibt eine präzise, individuelle Einschätzung." data-en="A free consultation with scalp analysis gives a precise, individual assessment." data-fr="Une consultation gratuite avec analyse du cuir chevelu permet une évaluation précise et individuelle." data-nl="Een gratis consult met hoofdhuidanalyse geeft een nauwkeurige, individuele inschatting." data-it="Un consulto gratuito con analisi del cuoio capelluto fornisce una valutazione precisa e personalizzata." data-tr="Saç derisi analizi içeren ücretsiz bir danışma, hassas ve kişiye özel bir değerlendirme sağlar.">Eine kostenlose Beratung mit Haaranalyse gibt eine präzise, individuelle Einschätzung.</p>
    </div>
  </div>
  <div class="hp-checklist">
    ...
    <div class="hp-check"><span class="tick">✓</span><p data-de="Frauen mit androgenetischer Alopezie können ebenfalls geeignete Kandidatinnen sein. Bei diffusem Haarausfall über die gesamte Kopfhaut reicht die stabile Spenderdichte jedoch oft nicht aus, eine fachärztliche Beurteilung ist essenziell." data-en="Women with androgenetic alopecia can also be suitable candidates. With diffuse hair loss across the entire scalp, stable donor density is often insufficient, so a specialist assessment is essential." data-fr="Les femmes atteintes d'alopécie androgénétique peuvent également être de bonnes candidates. En cas de chute de cheveux diffuse sur l'ensemble du cuir chevelu, la densité donneuse stable est souvent insuffisante, une évaluation par un spécialiste est donc essentielle." data-nl="Vrouwen met androgenetische alopecia kunnen ook geschikte kandidaten zijn. Bij diffuse haaruitval over de hele hoofdhuid is de stabiele donordichtheid vaak onvoldoende, dus een beoordeling door een specialist is essentieel." data-it="Anche le donne con alopecia androgenetica possono essere candidate idonee. In caso di caduta diffusa dei capelli su tutto il cuoio capelluto, la densità donatrice stabile è spesso insufficiente, quindi una valutazione specialistica è essenziale." data-tr="Androgenetik alopesisi olan kadınlar da uygun aday olabilir. Tüm saç derisinde yaygın saç dökülmesi durumunda kararlı donör yoğunluğu genellikle yetersiz kalır, bu nedenle uzman değerlendirmesi şarttır.">Frauen mit androgenetischer Alopezie können ebenfalls geeignete Kandidatinnen sein. Bei diffusem Haarausfall über die gesamte Kopfhaut reicht die stabile Spenderdichte jedoch oft nicht aus, eine fachärztliche Beurteilung ist essenziell.</p></div>
  </div>
  </div>
</section>
...
<section class="hp-section" id="genesung-service">
  <div class="hp-section-head">
    ...
    <div>
      <h2 data-ckey="genesungService.heading" data-de="Genesung &amp; Nachsorge" data-en="Recovery &amp; aftercare" data-fr="Récupération et suivi" data-nl="Herstel &amp; nazorg" data-it="Recupero e assistenza post-operatoria" data-tr="İyileşme ve Bakım">Genesung &amp; Nachsorge</h2>
      <p data-ckey="genesungService.body" data-de="Die Erholungsphase ist genauso wichtig wie der Eingriff selbst. Sie bestimmt Graft-Überleben, Heilungsqualität und Endergebnis." data-en="The recovery period matters as much as the procedure itself. It determines graft survival, healing quality, and the final result." data-fr="La période de récupération compte autant que l'intervention elle-même. Elle détermine la survie des greffons, la qualité de la cicatrisation et le résultat final." data-nl="De hersteltijd is net zo belangrijk als de ingreep zelf. Deze bepaalt de overleving van de grafts, de kwaliteit van de genezing en het eindresultaat." data-it="Il periodo di recupero è importante quanto l'intervento stesso. Determina la sopravvivenza degli innesti, la qualità della guarigione e il risultato finale." data-tr="İyileşme süreci, işlemin kendisi kadar önemlidir. Greft sağkalımını, iyileşme kalitesini ve nihai sonucu belirler.">Die Erholungsphase ist genauso wichtig wie der Eingriff selbst. Sie bestimmt Graft-Überleben, Heilungsqualität und Endergebnis.</p>
    </div>
  </div>
...
<section class="hp-section alt" id="ergebnisse">
  ...
  <div class="hp-section-head">
    ...
    <div>
      <h2 data-ckey="ergebnisse.heading" data-de="Ergebnisse: was Sie realistisch erwarten können" data-en="Results: what to realistically expect" data-fr="Résultats : à quoi s'attendre réellement" data-nl="Resultaten: wat u realistisch kunt verwachten" data-it="Risultati: cosa aspettarsi realisticamente" data-tr="Sonuçlar: Gerçekçi Olarak Neler Beklenmeli">Ergebnisse: was Sie realistisch erwarten können</h2>
      <p data-ckey="ergebnisse.body" data-de="Das vollständige Ergebnis zeigt sich erst nach 12 bis 18 Monaten, nicht sofort." data-en="Full results are visible at 12 to 18 months, not immediately." data-fr="Le résultat complet est visible entre 12 et 18 mois, pas immédiatement." data-nl="Het volledige resultaat is pas na 12 tot 18 maanden zichtbaar, niet meteen." data-it="Il risultato completo è visibile dopo 12-18 mesi, non immediatamente." data-tr="Tam sonuç hemen değil, 12 ila 18 ay içinde ortaya çıkar.">Das vollständige Ergebnis zeigt sich erst nach 12 bis 18 Monaten, nicht sofort.</p>
    </div>
  </div>
  ...
  <p style="font-size:14px;color:var(--ink-soft);line-height:1.6;max-width:640px" data-de="Möchten Sie tiefer eintauchen? Unsere &lt;a href=&quot;hairpedia.php&quot; style=&quot;color:var(--blue-700);text-decoration:underline;font-weight:600;&quot;&gt;Hairpedia&lt;/a&gt; behandelt Haarausfall, Diagnose, Techniken und den vollständigen Monat-für-Monat-Heilungsverlauf im Detail." data-en="Want to go deeper? Our &lt;a href=&quot;hairpedia.php&quot; style=&quot;color:var(--blue-700);text-decoration:underline;font-weight:600;&quot;&gt;Hairpedia&lt;/a&gt; covers hair loss, diagnosis, techniques, and the full month-by-month healing timeline in detail." data-fr="Vous voulez approfondir ? Notre &lt;a href=&quot;hairpedia.php&quot; style=&quot;color:var(--blue-700);text-decoration:underline;font-weight:600;&quot;&gt;Hairpedia&lt;/a&gt; traite en détail la chute de cheveux, le diagnostic, les techniques et la chronologie complète de guérison mois par mois." data-nl="Wilt u meer weten? Onze &lt;a href=&quot;hairpedia.php&quot; style=&quot;color:var(--blue-700);text-decoration:underline;font-weight:600;&quot;&gt;Hairpedia&lt;/a&gt; behandelt haaruitval, diagnose, technieken en de volledige maand-voor-maand genezingstijdlijn in detail." data-it="Vuoi approfondire? La nostra &lt;a href=&quot;hairpedia.php&quot; style=&quot;color:var(--blue-700);text-decoration:underline;font-weight:600;&quot;&gt;Hairpedia&lt;/a&gt; tratta in dettaglio la caduta dei capelli, la diagnosi, le tecniche e la cronologia completa di guarigione mese per mese." data-tr="Daha derinlemesine bilgi mi istiyorsunuz? &lt;a href=&quot;hairpedia.php&quot; style=&quot;color:var(--blue-700);text-decoration:underline;font-weight:600;&quot;&gt;Hairpedia&lt;/a&gt;'mız saç dökülmesini, teşhisi, teknikleri ve ay ay tam iyileşme sürecini ayrıntılı olarak ele alır.">Möchten Sie tiefer eintauchen? Unsere <a href="hairpedia.php" style="color:var(--blue-700);text-decoration:underline;font-weight:600;">Hairpedia</a> behandelt Haarausfall, Diagnose, Techniken und den vollständigen Monat-für-Monat-Heilungsverlauf im Detail.</p>
  </div>
</section>
